...
<div class="block-wrapper">
	<h2 class="section-title"><?php esc_html_e( 'Control Settings for Blocks', 'cozy-addons' ); ?></h2>
	<p><?php esc_html_e( 'Selectively enable or disable each block from this panel. Turning off blocks you don\'t use reduces the number of scripts and styles loaded on your site, improving page speed without affecting the blocks you keep active.', 'cozy-addons' ); ?>
	</p>
		...
		<ul id="general-blocks" class="blocks-list grid-layout cols-4">
				...
				<div class="flex-layout">
					...
					<div>
						...
						<p class="block-helper-links">
							...
							<a href="https://docs.cozythemes.com/cozy-blocks/accordion/" target="_blank"
								rel="noopener"><?php esc_html_e( 'Docs', 'cozy-addons' ); ?></a>
						</p>
					</div>
				</div>
			...
			<li class="block-item flex-layout">
				<div class="flex-layout">
					<i class="block-icon">
						<svg width="26" height="26" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
							<path
								d="M37 1C43.6274 1 49 6.37258 49 13V37C49 43.6274 43.6274 49 37 49H13C6.37258 49 1 43.6274 1 37V13C1 6.37258 6.37258 1 13 1H37ZM13 3C7.47715 3 3 7.47715 3 13V37C3 42.5228 7.47715 47 13 47H37C42.5228 47 47 42.5228 47 37V13C47 7.47715 42.5228 3 37 3H13Z"
								fill="currentColor" />
							<rect x="19.5" y="16.5" width="15" height="15" stroke="currentColor" />
							<path d="M15.75 35.25H31V36H15V20H15.75V35.25Z" fill="currentColor" />
							<path d="M21 30L27 24L33 30" stroke="currentColor" />
						</svg>
					</i>
					<div>
						<h4 class="block-title"><?php esc_html_e( 'Advanced Gallery', 'cozy-addons' ); ?></h4>
						<p class="block-helper-links">
							<a href="https://cozyblock.cozythemes.com/advanced-gallery-gutenberg-block/" target="_blank"
								rel="noopener"><?php esc_html_e( 'Demo', 'cozy-addons' ); ?></a>
							<span class="link-separator">
								<svg width="2" height="2" viewBox="0 0 2 2" fill="none"
									xmlns="http://www.w3.org/2000/svg">
							...
							<a href="https://docs.cozythemes.com/cozy-blocks/advanced-gallery/" target="_blank"
								rel="noopener"><?php esc_html_e( 'Docs', 'cozy-addons' ); ?></a>
						</p>
					</div>
				</div>
				<div class="toggle-switcher-wrap">
					...
					?>
					<input type="checkbox" class="cozy-block-active" name="advanced-gallery"
			...
			<li class="block-item flex-layout">
				<div class="flex-layout">
					<i class="block-icon">
						<svg width="26" height="26" viewBox="0 0 48 50" fill="none" xmlns="http://www.w3.org/2000/svg">
							<path
								...
								fill="currentColor" />
							<rect x="7" y="13.5" width="34" height="8" rx="4" stroke="currentColor" />
							<path d="M34 17L35.2929 18.2929C35.6834 18.6834 36.3166 18.6834 36.7071 18.2929L38 17"
								stroke="currentColor" stroke-linecap="round" />
							<line x1="10.5" y1="17.5" x2="17.5" y2="17.5" stroke="#A0C1FF" stroke-linecap="round" />
							<path
								d="M15 21.5V36.5C15 36.7761 15.2239 37 15.5 37H38.5081C38.7811 37 39.0036 36.7811 39.0081 36.5082L39.25 21.75"
								stroke="currentColor" stroke-linecap="round" />
					...
					<div>
						<h4 class="block-title"><?php esc_html_e( 'Advanced Mega Menu', 'cozy-addons' ); ?></h4>
						<p class="block-helper-links">
							<a href="https://cozyblock.cozythemes.com/mega-menu-gutenberg-block/" target="_blank"
								rel="noopener"><?php esc_html_e( 'Demo', 'cozy-addons' ); ?></a>
							<span class="link-separator">
								<svg width="2" height="2" viewBox="0 0 2 2" fill="none"
									xmlns="http://www.w3.org/2000/svg">
							...
							<a href="https://docs.cozythemes.com/cozy-blocks/mega-menu/" target="_blank"
								rel="noopener"><?php esc_html_e( 'Docs', 'cozy-addons' ); ?></a>
						</p>
					</div>
				</div>
				...
				<div class="flex-layout">
					...
					<div>
						...
						<p class="block-helper-links">
							...
							<a href="https://docs.cozythemes.com/cozy-blocks/advanced-tabs/" target="_blank"
								rel="noopener"><?php esc_html_e( 'Docs', 'cozy-addons' ); ?></a>
						</p>
					</div>
				</div>
				...
				<div class="flex-layout">
					<i class="block-icon">
						<svg width="26" height="26" viewBox="0 0 47 46" fill="none" xmlns="http://www.w3.org/2000/svg">
							<rect x="1" y="1" width="45" height="44" rx="22" stroke="currentColor" stroke-width="2" />
							<path d="M16 27L22.5858 20.4142C23.3668 19.6332 24.6332 19.6332 25.4142 20.4142L32 27"
								stroke="currentColor" stroke-width="2" stroke-linecap="round" />
						</svg>
					</i>
					<div>
						<h4 class="block-title"><?php esc_html_e( 'Scroll to Top', 'cozy-addons' ); ?></h4>
						<p class="block-helper-links">
							<a href="https://cozyblock.cozythemes.com/back-to-top-gutenberg-block/" target="_blank"
								rel="noopener"><?php esc_html_e( 'Demo', 'cozy-addons' ); ?></a>
							<span class="link-separator">
								<svg width="2" height="2" viewBox="0 0 2 2" fill="none"
									xmlns="http://www.w3.org/2000/svg">
							...
							<a href="https://docs.cozythemes.com/cozy-blocks/back-to-top/" target="_blank"
								rel="noopener"><?php esc_html_e( 'Docs', 'cozy-addons' ); ?></a>
						</p>
					</div>
				</div>
			...
			<li class="block-item flex-layout">
				<div class="flex-layout">
					<i class="block-icon">
						<svg width="25" height="23" viewBox="0 0 25 23" fill="none" xmlns="http://www.w3.org/2000/svg">
							<path
								d="M13.1211 0C13.3972 1.20706e-08 13.6211 0.223858 13.6211 0.5V2.80469H20.6826C22.8917 2.80469 24.6825 4.59564 24.6826 6.80469V13.3896C24.6826 15.5988 22.8918 17.3896 20.6826 17.3896H15.5205L17.2949 21.293C17.409 21.5442 17.298 21.8407 17.0469 21.9551C16.7956 22.0692 16.4991 21.9583 16.3848 21.707L14.4219 17.3896H13.1211V22C13.1209 22.276 12.8971 22.5 12.6211 22.5C12.3451 22.5 12.1213 22.276 12.1211 22V17.3896H10.7578L8.79688 21.707C8.68266 21.9584 8.38521 22.0693 8.13379 21.9551C7.88295 21.8407 7.77187 21.5451 7.88574 21.2939L9.65918 17.3896H4C1.79101 17.3895 0 15.5987 0 13.3896V6.80469C0.000104213 4.59575 1.79108 2.80487 4 2.80469H12.6211V0.5C12.6211 0.223858 12.845 -1.20706e-08 13.1211 0ZM4 3.80469C2.34336 3.80487 1.0001 5.14803 1 6.80469V13.3896C1 15.0464 2.3433 16.3895 4 16.3896H10.1133L10.3848 15.793L11.2949 16.207L11.2119 16.3896H13.9678L13.8848 16.207L14.7949 15.793L15.0664 16.3896H20.6826C22.3395 16.3896 23.6826 15.0465 23.6826 13.3896V6.80469C23.6825 5.14792 22.3394 3.80469 20.6826 3.80469H4ZM6.79297 9.09766C7.06911 9.09766 7.29297 9.32151 7.29297 9.59766C7.29297 9.8738 7.06911 10.0977 6.79297 10.0977H4.42676C4.15078 10.0975 3.92676 9.87368 3.92676 9.59766C3.92676 9.32163 4.15078 9.09785 4.42676 9.09766H6.79297ZM11.2812 9.09766C11.5574 9.09766 11.7813 9.32151 11.7812 9.59766C11.7812 9.8738 11.5574 10.0977 11.2812 10.0977H8.91504C8.63906 10.0975 8.41504 9.87368 8.41504 9.59766C8.41504 9.32163 8.63906 9.09785 8.91504 9.09766H11.2812ZM15.7695 9.09766C16.0457 9.09766 16.2695 9.32151 16.2695 9.59766C16.2695 9.8738 16.0457 10.0977 15.7695 10.0977H13.4033C13.1273 10.0975 12.9033 9.87368 12.9033 9.59766C12.9033 9.32163 13.1273 9.09785 13.4033 9.09766H15.7695ZM20.2578 9.09766C20.534 9.09766 20.7578 9.32151 20.7578 9.59766C20.7578 9.8738 20.534 10.0977 20.2578 10.0977H17.8916C17.6156 10.0975 17.3916 9.87368 17.3916 9.59766C17.3916 9.32163 17.6156 9.09785 17.8916 9.09766H20.2578Z"
								fill="currentColor" />
						</svg>
					</i>
					<div>
						<h4 class="block-title"><?php esc_html_e( 'Brand Showcase', 'cozy-addons' ); ?></h4>
						<p class="block-helper-links">
							<a href="https://cozyblock.cozythemes.com/brand-showcase-gutenberg-block/" target="_blank"
								rel="noopener"><?php esc_html_e( 'Demo', 'cozy-addons' ); ?></a>
							<span class="link-separator">
								<svg width="2" height="2" viewBox="0 0 2 2" fill="none"
									xmlns="http://www.w3.org/2000/svg">
							...
							<a href="https://docs.cozythemes.com/cozy-blocks/brand-showcase/" target="_blank"
								rel="noopener"><?php esc_html_e( 'Docs', 'cozy-addons' ); ?></a>
						</p>
					</div>
				</div>
				<div class="toggle-switcher-wrap">
					<?php
					$checked = get_option( 'cozy-block--brand-showcase' );
					?>
					<input type="checkbox" class="cozy-block-active" name="brand-showcase" id="cozy-block--brand-showcase"
						<?php echo '1' === $checked || '' == $checked ? 'checked' : ''; ?>>
					<span class="toggle-switcher"></span>
				</div>
			</li>
				...
				<div class="flex-layout">
					...
					<div>
						...
						<p class="block-helper-links">
							...
							<a href="https://docs.cozythemes.com/cozy-blocks/breadcrumbs/" target="_blank"
								rel="noopener"><?php esc_html_e( 'Docs', 'cozy-addons' ); ?></a>
						</p>
					</div>
				</div>
				...
				<div class="flex-layout">
					...
					<div>
						...
						<p class="block-helper-links">
							...
							<a href="https://docs.cozythemes.com/cozy-blocks/cozy-buttons/" target="_blank"
								rel="noopener"><?php esc_html_e( 'Docs', 'cozy-addons' ); ?></a>
						</p>
					</div>
				</div>
				...
				<div class="flex-layout">
					<i class="block-icon">
						<svg width="26" height="26" viewBox="0 0 52 50" fill="none" xmlns="http://www.w3.org/2000/svg">
							<path
								d="M38.3096 3.00391C44.7939 3.16811 50 8.47608 50 15V25H48V15C48 9.64975 43.7983 5.28054 38.5146 5.0127L38 5H12C6.47715 5 2 9.47715 2 15V35C2 40.5228 6.47715 45 12 45H31V47H12C5.47608 47 0.168106 41.7939 0.00390625 35.3096L0 35V15C0 8.47608 5.20608 3.16811 11.6904 3.00391L12 3H38L38.3096 3.00391Z"
								fill="currentColor" />
							<path d="M14 17L20.8946 22.3219C22.9559 23.913 25.8082 23.9929 27.9554 22.5197L36 17"
								stroke="currentColor" stroke-width="2" stroke-linecap="round" />
							<path
								d="M44.7273 32.8788L48.4606 36.7576M48.4606 36.7576L49.9468 35.3324C51.0931 34.2333 51.1652 32.4245 50.1102 31.2376C49.016 30.0067 47.1266 29.9081 45.9104 31.0186L37.0444 39.1136C36.9959 39.1579 36.9633 39.2168 36.9516 39.2813L36.0775 44.0747C36.04 44.2806 36.2195 44.4607 36.4255 44.4238L41.2446 43.5613C41.3025 43.551 41.356 43.5238 41.3986 43.4833L48.4606 36.7576Z"
								stroke="currentColor" stroke-width="1.5" />
						</svg>
					</i>
					<div>
						<h4 class="block-title has-icon">
						...
						<p class="block-helper-links">
							<a href="https://cozyblock.cozythemes.com/contact-form-styler-gutenberg-block/"
								target="_blank" rel="noopener"><?php esc_html_e( 'Demo', 'cozy-addons' ); ?></a>
							<span class="link-separator">
								<svg width="2" height="2" viewBox="0 0 2 2" fill="none"
									xmlns="http://www.w3.org/2000/svg">
									<circle cx="1" cy="1" r="1" fill="currentColor" />
							...
							<a href="https://docs.cozythemes.com/cozy-blocks/contact-form-7-styler/" target="_blank"
								rel="noopener"><?php esc_html_e( 'Docs', 'cozy-addons' ); ?></a>
						</p>
					</div>
				</div>
				<div class="toggle-switcher-wrap">
					...
					<div class="cozy-block-upsell-tooltip">
						<a href="https://cozythemes.com/pricing-and-plans/" target="_blank"
							rel="noopener"><?php esc_html_e( 'Upgrade to Pro', 'cozy-addons' ); ?></a>
			...
			<li class="block-item flex-layout">
				<div class="flex-layout">
					...
					<div>
						<h4 class="block-title"><?php esc_html_e( 'Cozy Container', 'cozy-addons' ); ?></h4>
						<p class="block-helper-links">
							<a href="https://cozyblock.cozythemes.com/cozy-container-gutenberg-block/" target="_blank"
								rel="noopener"><?php esc_html_e( 'Demo', 'cozy-addons' ); ?></a>
							<span class="link-separator">
								<svg width="2" height="2" viewBox="0 0 2 2" fill="none"
									xmlns="http://www.w3.org/2000/svg">
							...
							<a href="https://docs.cozythemes.com/cozy-blocks/cozy-container/" target="_blank"
								rel="noopener"><?php esc_html_e( 'Docs', 'cozy-addons' ); ?></a>
						</p>
					</div>
				</div>
			...
			<li class="block-item flex-layout">
				<div class="flex-layout">
					...
					<div>
						...
						<p class="block-helper-links">
							<a href="https://cozyblock.cozythemes.com/countdown-timer-gutenberg-block/" target="_blank"
								rel="noopener"><?php esc_html_e( 'Demo', 'cozy-addons' ); ?></a>
							<span class="link-separator">
								<svg width="2" height="2" viewBox="0 0 2 2" fill="none"
									xmlns="http://www.w3.org/2000/svg">
							...
							<a href="https://docs.cozythemes.com/cozy-blocks/countdown-timer/" target="_blank"
								rel="noopener"><?php esc_html_e( 'Docs', 'cozy-addons' ); ?></a>
						</p>
					</div>
				</div>
				<div class="toggle-switcher-wrap">
					...
					?>
					<input type="checkbox" class="cozy-block-active" name="countdown-timer"
						id="cozy-block--countdown-timer"
						<?php echo cozy_addons_premium_access() && ( '1' === $checked || '' == $checked ) ? 'checked' : ''; ?>>
					<?php
					$classes   = array();
					$classes[] = 'toggle-switcher';
				...
				<div class="flex-layout">
					...
					<div>
						...
						<p class="block-helper-links">
							...
							<a href="https://docs.cozythemes.com/cozy-blocks/counter/" target="_blank"
								rel="noopener"><?php esc_html_e( 'Docs', 'cozy-addons' ); ?></a>
						</p>
					</div>
				</div>
				...
				<div class="flex-layout">
					<i class="block-icon">
						<svg width="26" height="26" viewBox="0 0 48 50" fill="none" xmlns="http://www.w3.org/2000/svg">
							...
							<rect x="19.5" y="31" width="9" height="3" rx="1.5" fill="currentColor" />
							<rect x="22.5" y="16" width="3" height="3" rx="1.5" fill="currentColor" />
							<rect x="1" y="2" width="46" height="46" rx="11" stroke="currentColor" stroke-width="2" />
						</svg>
					</i>
					<div>
						<h4 class="block-title"><?php esc_html_e( 'Call to Action(CTA)', 'cozy-addons' ); ?></h4>
						<p class="block-helper-links">
							<a href="https://cozyblock.cozythemes.com/call-to-action-gutenberg-block/" target="_blank"
								rel="noopener"><?php esc_html_e( 'Demo', 'cozy-addons' ); ?></a>
							<span class="link-separator">
								<svg width="2" height="2" viewBox="0 0 2 2" fill="none"
									xmlns="http://www.w3.org/2000/svg">
							...
							<a href="https://docs.cozythemes.com/cozy-blocks/call-to-action/" target="_blank"
								rel="noopener"><?php esc_html_e( 'Docs', 'cozy-addons' ); ?></a>
						</p>
					</div>
				</div>
			...
			<li class="block-item flex-layout">
				<div class="flex-layout">
					<i class="block-icon">
						<svg width="26" height="26" viewBox="0 0 52 50" fill="none" xmlns="http://www.w3.org/2000/svg">
							<path
								d="M42.7812 33C47.4757 33 51.2812 36.8056 51.2812 41.5C51.2812 46.1944 47.4757 50 42.7812 50C38.0868 50 34.2812 46.1944 34.2812 41.5C34.2812 36.8056 38.0868 33 42.7812 33ZM37.7812 0C38.3335 0 38.7812 0.447715 38.7812 1V2.83789C45.0445 3.2404 50 8.44756 50 14.8125V33.293C49.3818 32.8153 48.7127 32.4005 48 32.0615V14.8125C48 9.55262 43.9389 5.24338 38.7812 4.84473V6C38.7812 6.55228 38.3335 7 37.7812 7C37.229 7 36.7812 6.55228 36.7812 6V4.8125H12C11.9269 4.8125 11.854 4.81582 11.7812 4.81738V6C11.7812 6.55228 11.3335 7 10.7812 7C10.229 7 9.78125 6.55228 9.78125 6V5.06152C5.32642 6.07091 2 10.0523 2 14.8125V36.8125C2 42.3353 6.47715 46.8125 12 46.8125H33.3887C33.7366 47.5263 34.1608 48.1954 34.6484 48.8125H12C5.37258 48.8125 0 43.4399 0 36.8125V14.8125C0 8.94329 4.21403 4.06046 9.78125 3.01953V1C9.78125 0.447715 10.229 0 10.7812 0C11.3335 0 11.7812 0.447715 11.7812 1V2.81445L12 2.8125H36.7812V1C36.7812 0.447715 37.229 0 37.7812 0ZM42.7812 35C39.1914 35 36.2812 37.9101 36.2812 41.5C36.2812 45.0899 39.1914 48 42.7812 48C46.3711 48 49.2812 45.0899 49.2812 41.5C49.2812 37.9101 46.3711 35 42.7812 35ZM41.2812 38.5C41.5574 38.5 41.7812 38.7239 41.7812 39V43H44.7812C45.0574 43 45.2812 43.2239 45.2812 43.5C45.2812 43.7761 45.0574 44 44.7812 44H40.7812V39C40.7812 38.7239 41.0051 38.5 41.2812 38.5Z"
								fill="currentColor" />
							<rect width="5" height="5" rx="2.5" transform="matrix(-1 0 0 1 14.0312 24.5)"
								fill="currentColor" />
							<rect width="5" height="5" rx="2.5" transform="matrix(-1 0 0 1 21.1406 24.5)"
								fill="#7EA2FF" />
							<rect width="5" height="5" rx="2.5" transform="matrix(-1 0 0 1 14.0312 31.5)"
								fill="#B9C7EB" />
							<rect width="5" height="5" rx="2.5" transform="matrix(-1 0 0 1 21.1406 31.5)"
								fill="#E6EDFF" />
						</svg>
					</i>
					<div>
						<h4 class="block-title"><?php esc_html_e( 'Date & Time', 'cozy-addons' ); ?></h4>
						<p class="block-helper-links">
							<a href="https://cozyblock.cozythemes.com/date-and-time-gutenberg-block/" target="_blank"
								rel="noopener"><?php esc_html_e( 'Demo', 'cozy-addons' ); ?></a>
							<span class="link-separator">
								<svg width="2" height="2" viewBox="0 0 2 2" fill="none"
									xmlns="http://www.w3.org/2000/svg">
							...
							<a href="https://docs.cozythemes.com/cozy-blocks/date-time/" target="_blank"
								rel="noopener"><?php esc_html_e( 'Docs', 'cozy-addons' ); ?></a>
						</p>
					</div>
				</div>
			...
			<li class="block-item flex-layout">
					...
					<i class="block-icon">
						<svg width="26" height="26" viewBox="0 0 48 50" fill="none" xmlns="http://www.w3.org/2000/svg">
							<path
								...
								fill="currentColor" />
							<path
								d="M33.4474 12.9985H15.5526C12.7621 12.9985 10.5 15.2607 10.5 18.0512V20.9985C10.5 23.789 12.7621 26.0512 15.5526 26.0512H33.4474C36.2379 26.0512 38.5 23.789 38.5 20.9985V18.0512C38.5 15.2607 36.2379 12.9985 33.4474 12.9985Z"
								fill="currentColor" />
							...
							<rect x="18.9219" y="34.2583" width="10.9474" height="3.36842" rx="1.68421"
								fill="currentColor" />
						</svg>
					</i>
					<div>
						<h4 class="block-title"><?php esc_html_e( 'Featured Content Box', 'cozy-addons' ); ?></h4>
						<p class="block-helper-links">
							<a href="https://cozyblock.cozythemes.com/featured-content-box-gutenberg-block/"
								target="_blank" rel="noopener"><?php esc_html_e( 'Demo', 'cozy-addons' ); ?></a>
							<span class="link-separator">
								<svg width="2" height="2" viewBox="0 0 2 2" fill="none"
									xmlns="http://www.w3.org/2000/svg">
							...
							<a href="https://docs.cozythemes.com/cozy-blocks/featured-content-box/" target="_blank"
								rel="noopener"><?php esc_html_e( 'Docs', 'cozy-addons' ); ?></a>
						</p>
					</div>
				</div>
				<div class="toggle-switcher-wrap">
					...
					?>
					<input type="checkbox" class="cozy-block-active" name="featured-content-box"
						id="cozy-block--featured-content-box"
						<?php echo '1' === $checked || '' == $checked ? 'checked' : ''; ?>>
					<span class="toggle-switcher"></span>
				</div>
			</li>
				...
				<div class="flex-layout">
					...
					<div>
						...
						<p class="block-helper-links">
							...
							<a href="https://docs.cozythemes.com/cozy-blocks/icon-list/" target="_blank"
								rel="noopener"><?php esc_html_e( 'Docs', 'cozy-addons' ); ?></a>
						</p>
					</div>
				</div>
				...
				<div class="flex-layout">
					...
					<div>
						...
						<p class="block-helper-links">
							...
							<a href="https://docs.cozythemes.com/cozy-blocks/icon-picker/" target="_blank"
								rel="noopener"><?php esc_html_e( 'Docs', 'cozy-addons' ); ?></a>
						</p>
					</div>
				</div>
			...
			<li class="block-item flex-layout">
				<div class="flex-layout">
					<i class="block-icon">
						<svg width="26" height="26" viewBox="0 0 49 50" fill="none" xmlns="http://www.w3.org/2000/svg">
							<rect x="1" y="1.5" width="47" height="47" rx="23.5" stroke="currentColor"
								stroke-width="2" />
							<path
								d="M24 48.4932C11.2522 48.2271 1 37.8116 1 25C1 12.1884 11.2522 1.77195 24 1.50586V48.4932Z"
								fill="#CFE0FF" stroke="currentColor" stroke-width="2" />
							<rect x="20" y="22.5" width="8" height="8" rx="4" fill="currentColor" />
					...
					<div>
						...
						<p class="block-helper-links">
							<a href="https://cozyblock.cozythemes.com/before-after-image-gutenberg-block/"
								target="_blank" rel="noopener"><?php esc_html_e( 'Demo', 'cozy-addons' ); ?></a>
							<span class="link-separator">
								<svg width="2" height="2" viewBox="0 0 2 2" fill="none"
									xmlns="http://www.w3.org/2000/svg">
							...
							<a href="https://docs.cozythemes.com/cozy-blocks/before-after-image/" target="_blank"
								rel="noopener"><?php esc_html_e( 'Docs', 'cozy-addons' ); ?></a>
						</p>
					</div>
				</div>
				<div class="toggle-switcher-wrap">
					...
					?>
					<input type="checkbox" class="cozy-block-active" name="img-compare" id="cozy-block--img-compare"
						<?php echo cozy_addons_premium_access() && ( '1' === $checked || '' == $checked ) ? 'checked' : ''; ?>>
					<?php
					$classes   = array();
					$classes[] = 'toggle-switcher';
			...
			<li class="block-item flex-layout">
					...
					<i class="block-icon">
						<svg width="26" height="26" viewBox="0 0 51 50" fill="none" xmlns="http://www.w3.org/2000/svg">
							...
							<rect width="11" height="11" rx="5.5" transform="matrix(-1 0 0 1 50.9375 1.12109)"
								fill="#C2D3FF" />
							<path d="M47.1797 8.36572L44.9068 6.09288L42.937 4.12308" stroke="currentColor"
								stroke-linecap="round" />
							<path d="M43.1797 8.3667L45.4525 6.09386L47.4223 4.12406" stroke="currentColor"
								stroke-linecap="round" />
							<rect x="14" y="26.8789" width="14" height="2" rx="1" fill="#94AAE0" />
							<rect x="29" y="26.8789" width="9" height="2" rx="1" fill="currentColor" />
							...
							<rect x="21" y="31.8789" width="9" height="3" rx="1.5" fill="currentColor" />
						</svg>
					</i>
					<div>
						<h4 class="block-title has-icon">
						...
						<p class="block-helper-links">
							<a href="https://cozyblock.cozythemes.com/popup-builder-gutenberg-block/" target="_blank"
								rel="noopener"><?php esc_html_e( 'Demo', 'cozy-addons' ); ?></a>
							<span class="link-separator">
								<svg width="2" height="2" viewBox="0 0 2 2" fill="none"
									xmlns="http://www.w3.org/2000/svg">
							...
							<a href="https://docs.cozythemes.com/cozy-blocks/popup-builder/" target="_blank"
								rel="noopener"><?php esc_html_e( 'Docs', 'cozy-addons' ); ?></a>
						</p>
					</div>
				</div>
				<div class="toggle-switcher-wrap">
					...
					?>
					<input type="checkbox" class="cozy-block-active" name="modal" id="cozy-block--modal"
						<?php echo cozy_addons_premium_access() && ( '1' === $checked || '' == $checked ) ? 'checked' : ''; ?>>
					<?php
					$classes   = array();
					$classes[] = 'toggle-switcher';
			...
			<li class="block-item flex-layout">
				<div class="flex-layout">
					<i class="block-icon">
						<svg width="26" height="26" viewBox="0 0 48 50" fill="none" xmlns="http://www.w3.org/2000/svg">
							...
							<path d="M20 17L9 32.5H31.5L20 17Z" fill="currentColor" />
						</svg>
					</i>
					<div>
						<h4 class="block-title"><?php esc_html_e( 'Portfolio Gallery', 'cozy-addons' ); ?></h4>
						<p class="block-helper-links">
							<a href="https://cozyblock.cozythemes.com/portfolio-gallery-gutenberg-block/"
								target="_blank" rel="noopener"><?php esc_html_e( 'Demo', 'cozy-addons' ); ?></a>
							<span class="link-separator">
								<svg width="2" height="2" viewBox="0 0 2 2" fill="none"
									xmlns="http://www.w3.org/2000/svg">
							...
							<a href="https://docs.cozythemes.com/cozy-blocks/portfolio-gallery/" target="_blank"
								rel="noopener"><?php esc_html_e( 'Docs', 'cozy-addons' ); ?></a>
						</p>
					</div>
				</div>
				<div class="toggle-switcher-wrap">
					...
					?>
					<input type="checkbox" class="cozy-block-active" name="portfolio-gallery"
						id="cozy-block--portfolio-gallery"
						<?php echo '1' === $checked || '' == $checked ? 'checked' : ''; ?>>
					<span class="toggle-switcher"></span>
				</div>
			</li>
			...
			<li class="block-item flex-layout">
				<div class="flex-layout">
					...
					<div>
						...
						<p class="block-helper-links">
							...
							<a href="https://docs.cozythemes.com/cozy-blocks/pricing-table/" target="_blank"
								rel="noopener"><?php esc_html_e( 'Docs', 'cozy-addons' ); ?></a>
						</p>
					</div>
				</div>
				<div class="toggle-switcher-wrap">
					...
					?>
					<input type="checkbox" class="cozy-block-active" name="pricing-table" id="cozy-block--pricing-table"
						<?php echo '1' === $checked || '' == $checked ? 'checked' : ''; ?>>
					<span class="toggle-switcher"></span>
				</div>
			</li>
				...
				<div class="flex-layout">
					<i class="block-icon">
						<svg width="26" height="26" viewBox="0 0 57 50" fill="none" xmlns="http://www.w3.org/2000/svg">
							<rect x="1" y="6.5" width="54.9941" height="16" rx="8" stroke="currentColor"
								stroke-width="2" />
							<rect x="18" y="9" width="35" height="11" rx="5.5" fill="currentColor" />
							<rect x="1" y="27.5" width="54.9941" height="16" rx="8" stroke="currentColor"
								stroke-width="2" />
							<rect x="6" y="32" width="2" height="8" rx="1" fill="currentColor" />
							<rect x="11" y="32" width="2" height="8" rx="1" fill="currentColor" />
							<rect x="16" y="32" width="2" height="8" rx="1" fill="currentColor" />
							<rect x="21" y="32" width="2" height="8" rx="1" fill="currentColor" />
							<rect x="26" y="32" width="2" height="8" rx="1" fill="currentColor" />
						</svg>
					</i>
					<div>
						<h4 class="block-title"><?php esc_html_e( 'Progress Bar', 'cozy-addons' ); ?></h4>
						<p class="block-helper-links">
							<a href="https://cozyblock.cozythemes.com/progress-bar-gutenberg-block/" target="_blank"
								rel="noopener"><?php esc_html_e( 'Demo', 'cozy-addons' ); ?></a>
							<span class="link-separator">
								<svg width="2" height="2" viewBox="0 0 2 2" fill="none"
									xmlns="http://www.w3.org/2000/svg">
							...
							<a href="https://docs.cozythemes.com/cozy-blocks/progress-bar/" target="_blank"
								rel="noopener"><?php esc_html_e( 'Docs', 'cozy-addons' ); ?></a>
						</p>
					</div>
				</div>
			...
			<li class="block-item flex-layout">
				<div class="flex-layout">
					<i class="block-icon">
						<svg width="26" height="26" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
							<rect x="1" y="1" width="48" height="48" rx="11" stroke="currentColor" stroke-width="2" />
							<path
								d="M29.5 20.5C31.857 20.5 33.0355 20.5 33.7678 21.2322C34.5 21.9645 34.5 23.143 34.5 25.5C34.5 27.857 34.5 29.0355 33.7678 29.7678C33.0355 30.5 31.857 30.5 29.5 30.5H21.5C19.143 30.5 17.9645 30.5 17.2322 29.7678C16.5 29.0355 16.5 27.857 16.5 25.5C16.5 23.143 16.5 21.9645 17.2322 21.2322C17.9645 20.5 19.143 20.5 21.5 20.5H29.5Z"
								stroke="currentColor" stroke-width="1.7" stroke-linecap="round"
								stroke-linejoin="round" />
							<path
								d="M30.5 15.5C30.3955 16.047 30.2107 16.4495 29.8838 16.7678C29.1316 17.5 27.9211 17.5 25.5 17.5C23.0789 17.5 21.8683 17.5 21.1162 16.7678C20.7893 16.4495 20.6045 16.047 20.5 15.5"
								stroke="currentColor" stroke-width="1.7" stroke-linecap="round"
								stroke-linejoin="round" />
							<path
								d="M30.5 35.5C30.3955 34.953 30.2107 34.5505 29.8838 34.2322C29.1316 33.5 27.9211 33.5 25.5 33.5C23.0789 33.5 21.8683 33.5 21.1162 34.2322C20.7893 34.5505 20.6045 34.953 20.5 35.5"
								stroke="currentColor" stroke-width="1.7" stroke-linecap="round"
								stroke-linejoin="round" />
						</svg>
					</i>
					<div>
						...
						<p class="block-helper-links">
							<a href="https://cozyblock.cozythemes.com/scroll-animation-gutenberg-block/" target="_blank"
								rel="noopener"><?php esc_html_e( 'Demo', 'cozy-addons' ); ?></a>
							<span class="link-separator">
								<svg width="2" height="2" viewBox="0 0 2 2" fill="none"
									xmlns="http://www.w3.org/2000/svg">
							...
							<a href="https://docs.cozythemes.com/cozy-blocks/scroll-animation/" target="_blank"
								rel="noopener"><?php esc_html_e( 'Docs', 'cozy-addons' ); ?></a>
						</p>
					</div>
				</div>
				<div class="toggle-switcher-wrap">
					...
					?>
					<input type="checkbox" class="cozy-block-active" name="scroll-animation"
						id="cozy-block--scroll-animation"
						<?php echo cozy_addons_premium_access() && ( '1' === $checked || '' == $checked ) ? 'checked' : ''; ?>>
					<?php
					$classes   = array();
					$classes[] = 'toggle-switcher';
				...
				<div class="flex-layout">
					<i class="block-icon">
						<svg width="26" height="26" viewBox="0 0 58 50" fill="none" xmlns="http://www.w3.org/2000/svg">
							<path
								d="M35 2C41.6274 2 47 7.37258 47 14V36C47 42.6274 41.6274 48 35 48H12L11.6904 47.9961C5.20608 47.8319 0 42.5239 0 36V14C0 7.47608 5.20608 2.16811 11.6904 2.00391L12 2H35ZM12 4C6.47715 4 2 8.47715 2 14V36C2 41.5228 6.47715 46 12 46H35C40.5228 46 45 41.5228 45 36V14C45 8.47715 40.5228 4 35 4H12Z"
								fill="currentColor" />
							<rect width="11" height="11" rx="5.5" transform="matrix(-1 0 0 1 57.9688 4)"
								fill="currentColor" />
							<path d="M54.2109 11.2444L51.9381 8.97154L49.9683 7.00174" stroke="white"
								stroke-linecap="round" />
							<path d="M50.2109 11.2456L52.4838 8.97276L54.4536 7.00296" stroke="white"
								stroke-linecap="round" />
					...
					<div>
						<h4 class="block-title"><?php esc_html_e( 'Sidebar Panel', 'cozy-addons' ); ?></h4>
						<p class="block-helper-links">
							<a href="https://cozyblock.cozythemes.com/sidebar-panel-gutenberg-block/" target="_blank"
								rel="noopener"><?php esc_html_e( 'Demo', 'cozy-addons' ); ?></a>
							<span class="link-separator">
								<svg width="2" height="2" viewBox="0 0 2 2" fill="none"
									xmlns="http://www.w3.org/2000/svg">
							...
							<a href="https://docs.cozythemes.com/cozy-blocks/sidebar-panel/" target="_blank"
								rel="noopener"><?php esc_html_e( 'Docs', 'cozy-addons' ); ?></a>
						</p>
					</div>
				</div>
			...
			<li class="block-item flex-layout">
				<div class="flex-layout">
					<i class="block-icon">
						<svg width="26" height="26" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
							<path
								d="M38.3096 2.00391C44.7939 2.16811 50 7.47608 50 14V30L49.9961 30.3096C49.8319 36.7939 44.5239 42 38 42H12C5.47608 42 0.168106 36.7939 0.00390625 30.3096L0 30V14C2.53686e-07 7.47608 5.20608 2.16811 11.6904 2.00391L12 2H38L38.3096 2.00391ZM12 4C6.47715 4 2 8.47715 2 14V30C2 35.5228 6.47715 40 12 40H38C43.5228 40 48 35.5228 48 30V14C48 8.64975 43.7983 4.28054 38.5146 4.0127L38 4H12ZM12.8311 17.2568C13.2415 16.8874 13.8737 16.9206 14.2432 17.3311C14.6126 17.7415 14.5794 18.3737 14.1689 18.7432L10.8203 21.7568C10.3793 22.154 10.3793 22.846 10.8203 23.2432L14.1689 26.2568C14.5794 26.6263 14.6126 27.2585 14.2432 27.6689C13.8737 28.0794 13.2415 28.1126 12.8311 27.7432L9.48242 24.7295C8.15882 23.5378 8.15882 21.4622 9.48242 20.2705L12.8311 17.2568ZM37.7568 17.3311C38.1263 16.9206 38.7585 16.8874 39.1689 17.2568L42.5176 20.2705C43.8412 21.4622 43.8412 23.5378 42.5176 24.7295L39.1689 27.7432C38.7585 28.1126 38.1263 28.0794 37.7568 27.6689C37.3874 27.2585 37.4206 26.6263 37.8311 26.2568L41.1797 23.2432C41.6207 22.846 41.6207 22.154 41.1797 21.7568L37.8311 18.7432C37.4206 18.3737 37.3874 17.7415 37.7568 17.3311Z"
								fill="currentColor" />
							<rect x="16.5" y="45" width="3" height="3" rx="1.5" fill="#CAD5F2" />
							<rect x="22.5" y="45" width="3" height="3" rx="1.5" fill="currentColor" />
							<rect x="28.5" y="45" width="3" height="3" rx="1.5" fill="#CAD5F2" />
						</svg>
					</i>
					<div>
						<h4 class="block-title"><?php esc_html_e( 'Slider', 'cozy-addons' ); ?></h4>
						<p class="block-helper-links">
							<a href="https://cozyblock.cozythemes.com/slider-gutenberg-block/" target="_blank"
								rel="noopener"><?php esc_html_e( 'Demo', 'cozy-addons' ); ?></a>
							<span class="link-separator">
								<svg width="2" height="2" viewBox="0 0 2 2" fill="none"
									xmlns="http://www.w3.org/2000/svg">
							...
							<a href="https://docs.cozythemes.com/cozy-blocks/slider/" target="_blank"
								rel="noopener"><?php esc_html_e( 'Docs', 'cozy-addons' ); ?></a>
						</p>
					</div>
				</div>
				...
				<div class="flex-layout">
					...
					<div>
						...
						<p class="block-helper-links">
							...
							<a href="https://docs.cozythemes.com/cozy-blocks/social-icons/" target="_blank"
								rel="noopener"><?php esc_html_e( 'Docs', 'cozy-addons' ); ?></a>
						</p>
					</div>
				</div>
			...
			<li class="block-item flex-layout">
				<div class="flex-layout">
					<i class="block-icon">
						<svg width="26" height="26" viewBox="0 0 49 50" fill="none" xmlns="http://www.w3.org/2000/svg">
							<circle cx="23.4993" cy="7.66653" r="6.27273" stroke="currentColor" stroke-width="2" />
							<mask id="path-2-inside-1_1419_622" fill="white">
								<path
									d="M23.5 17.105C29.0227 17.105 33.4998 21.5823 33.5 27.105V29.2485C33.4999 32.3731 32.066 35.1619 29.8213 36.9956C30.3448 37.9889 30.6426 39.1199 30.6426 40.3208V42.4634C30.6426 46.4082 27.4448 49.6058 23.5 49.606C19.5551 49.606 16.3564 46.4083 16.3564 42.4634V40.3208C16.3564 39.1197 16.654 37.9881 17.1777 36.9946C14.9336 35.1609 13.5001 32.3726 13.5 29.2485V27.105C13.5002 21.5823 17.9773 17.105 23.5 17.105Z" />
							</mask>
							<path
								d="M33.5 27.105H35.5V27.1049L33.5 27.105ZM33.5 29.2485L35.5 29.2486V29.2485H33.5ZM29.8213 36.9956L28.556 35.4467L27.2894 36.4814L28.052 37.9281L29.8213 36.9956ZM23.5 49.606V51.606H23.5001L23.5 49.606ZM17.1777 36.9946L18.9469 37.9273L19.7096 36.4807L18.4432 35.4459L17.1777 36.9946ZM13.5 29.2485H11.5V29.2486L13.5 29.2485ZM13.5 27.105L11.5 27.1049V27.105H13.5ZM23.5 17.105V19.105C27.9181 19.105 31.4998 22.6868 31.5 27.1051L33.5 27.105L35.5 27.1049C35.4998 20.4778 30.1274 15.105 23.5 15.105V17.105ZM33.5 27.105H31.5V29.2485H33.5H35.5V27.105H33.5ZM33.5 29.2485L31.5 29.2485C31.4999 31.7467 30.3562 33.9762 28.556 35.4467L29.8213 36.9956L31.0866 38.5445C33.7758 36.3476 35.4999 32.9994 35.5 29.2486L33.5 29.2485ZM29.8213 36.9956L28.052 37.9281C28.4285 38.6425 28.6426 39.4545 28.6426 40.3208H30.6426H32.6426C32.6426 38.7854 32.2611 37.3353 31.5906 36.0631L29.8213 36.9956ZM30.6426 40.3208H28.6426V42.4634H30.6426H32.6426V40.3208H30.6426ZM30.6426 42.4634H28.6426C28.6426 45.3035 26.3403 47.6059 23.4999 47.606L23.5 49.606L23.5001 51.606C28.5493 51.6058 32.6426 47.5128 32.6426 42.4634H30.6426ZM23.5 49.606V47.606C20.6593 47.606 18.3564 45.3033 18.3564 42.4634H16.3564H14.3564C14.3564 47.5132 18.4509 51.606 23.5 51.606V49.606ZM16.3564 42.4634H18.3564V40.3208H16.3564H14.3564V42.4634H16.3564ZM16.3564 40.3208H18.3564C18.3564 39.4538 18.5705 38.6414 18.9469 37.9273L17.1777 36.9946L15.4085 36.0619C14.7375 37.3347 14.3564 38.7856 14.3564 40.3208H16.3564ZM17.1777 36.9946L18.4432 35.4459C16.6435 33.9753 15.5001 31.7463 15.5 29.2485L13.5 29.2485L11.5 29.2486C11.5001 32.9988 13.2238 36.3465 15.9122 38.5433L17.1777 36.9946ZM13.5 29.2485H15.5V27.105H13.5H11.5V29.2485H13.5ZM13.5 27.105L15.5 27.105C15.5002 22.6868 19.0819 19.105 23.5 19.105V17.105V15.105C16.8726 15.105 11.5002 20.4778 11.5 27.1049L13.5 27.105Z"
								fill="currentColor" mask="url(#path-2-inside-1_1419_622)" />
							<circle cx="10" cy="11.4329" r="3.5" stroke="currentColor" stroke-width="2" />
							<path
								d="M11.5069 20.0499C8.69824 19.6062 3.20375 20.1354 1.50391 25.9329C-0.195939 31.7303 2.78786 34.8393 4.76613 35.6527V45.9314"
								stroke="currentColor" stroke-width="2" stroke-linecap="round" />
							<circle cx="4.5" cy="4.5" r="3.5" transform="matrix(-1 0 0 1 43.5 6.93286)"
								stroke="currentColor" stroke-width="2" />
							<path
								d="M37.5009 20.0499C40.3096 19.6062 45.8041 20.1354 47.5039 25.9329C49.2038 31.7303 46.22 34.8393 44.2417 35.6527V45.9314"
								stroke="currentColor" stroke-width="2" stroke-linecap="round" />
						</svg>
					</i>
					<div>
						<h4 class="block-title"><?php esc_html_e( 'Teams', 'cozy-addons' ); ?></h4>
						<p class="block-helper-links">
							<a href="https://cozyblock.cozythemes.com/team-gutenberg-block/" target="_blank"
								rel="noopener"><?php esc_html_e( 'Demo', 'cozy-addons' ); ?></a>
							<span class="link-separator">
								<svg width="2" height="2" viewBox="0 0 2 2" fill="none"
									xmlns="http://www.w3.org/2000/svg">
							...
							<a href="https://docs.cozythemes.com/cozy-blocks/teams/" target="_blank"
								rel="noopener"><?php esc_html_e( 'Docs', 'cozy-addons' ); ?></a>
						</p>
					</div>
				</div>
				...
				<div class="flex-layout">
					<i class="block-icon">
						<svg width="26" height="26" viewBox="0 0 50 48" fill="none" xmlns="http://www.w3.org/2000/svg">
							<path
								d="M33.0283 2.80444C41.9978 3.03205 49.199 10.374 49.1992 19.3982C49.1992 26.7506 44.4193 32.9824 37.7998 35.1648V47.3455L36.0674 45.4792L27.2646 35.9988H16.5996C7.43161 35.9988 0 28.566 0 19.3982C6.32724e-05 16.8188 0.587903 14.3767 1.6377 12.199H3.89551C2.68895 14.3235 2.00007 16.7803 2 19.3982C2 27.4616 8.53634 33.9988 16.5996 33.9988H28.1367L28.4326 34.3181L35.7998 42.2517V33.6667L36.5312 33.4626C42.6855 31.7459 47.1992 26.0979 47.1992 19.3982C47.199 11.4612 40.8653 5.00361 32.9766 4.80347L32.5996 4.79858H23V2.79858H32.5996L33.0283 2.80444Z"
								fill="currentColor" />
							<path
								d="M10.2557 1.00072C10.2147 0.999769 10.1728 0.999754 10.1301 1.00072M10.1301 1.00072C8.44627 1.03867 5.60893 2.59968 6.31334 8.55471C6.37092 9.04144 6.79265 9.4 7.28277 9.4H9.60313C10.1554 9.4 10.6031 8.95228 10.6031 8.4V6.20058C10.6031 5.6483 10.1554 5.20058 9.60313 5.20058H8.77704C8.34572 5.20058 7.95357 4.91852 7.96398 4.48733C7.9857 3.58728 8.44536 2.23235 10.1301 1.00072Z"
								stroke="currentColor" stroke-width="2" />
							<path
								d="M17.8495 1.00072C17.8084 0.999769 17.7665 0.999754 17.7239 1.00072M17.7239 1.00072C16.04 1.03867 13.2027 2.59968 13.9071 8.55471C13.9647 9.04144 14.3864 9.4 14.8765 9.4H17.1969C17.7492 9.4 18.1969 8.95228 18.1969 8.4V6.20058C18.1969 5.6483 17.7492 5.20058 17.1969 5.20058H16.3708C15.9395 5.20058 15.5473 4.91852 15.5577 4.48733C15.5794 3.58728 16.0391 2.23235 17.7239 1.00072Z"
								stroke="currentColor" stroke-width="2" />
							<path d="M12.6016 14.1477L36.002 14.6008" stroke="currentColor" stroke-width="2"
								stroke-linecap="round" />
							<path d="M12.6016 18.6008L35.8008 18.6516" stroke="currentColor" stroke-width="2"
								stroke-linecap="round" />
							<path d="M12.6016 22.6516L35.8008 22.7024" stroke="currentColor" stroke-width="2"
								stroke-linecap="round" />
							<path d="M12.6016 26.8293H12.6015" stroke="currentColor" stroke-width="2"
								stroke-linecap="round" />
							<path d="M15.6016 26.7024L36.0012 26.9563" stroke="currentColor" stroke-width="2"
								stroke-linecap="round" />
						</svg>
					</i>
					<div>
						<h4 class="block-title"><?php esc_html_e( 'Testimonials', 'cozy-addons' ); ?></h4>
						<p class="block-helper-links">
							<a href="https://cozyblock.cozythemes.com/testimonial-gutenberg-block/" target="_blank"
								rel="noopener"><?php esc_html_e( 'Demo', 'cozy-addons' ); ?></a>
							<span class="link-separator">
								<svg width="2" height="2" viewBox="0 0 2 2" fill="none"
									xmlns="http://www.w3.org/2000/svg">
							...
							<a href="https://docs.cozythemes.com/cozy-blocks/testimonials/" target="_blank"
								rel="noopener"><?php esc_html_e( 'Docs', 'cozy-addons' ); ?></a>
						</p>
					</div>
				</div>
			...
			<li class="block-item flex-layout">
				<div class="flex-layout">
					<i class="block-icon">
						<svg width="26" height="26" viewBox="0 0 48 50" fill="none" xmlns="http://www.w3.org/2000/svg">
							<rect x="1" y="11.5" width="46" height="27" rx="13.5" stroke="currentColor"
								stroke-width="2" />
							<rect x="26.5" y="18" width="14" height="14" rx="7" stroke="currentColor"
								stroke-width="2" />
						</svg>
					</i>
					<div>
						...
						<p class="block-helper-links">
							<a href="https://cozyblock.cozythemes.com/pricing-table-gutenberg-block#toggle-content"
								target="_blank" rel="noopener"><?php esc_html_e( 'Demo', 'cozy-addons' ); ?></a>
							<span class="link-separator">
								<svg width="2" height="2" viewBox="0 0 2 2" fill="none"
									xmlns="http://www.w3.org/2000/svg">
							...
							<a href="https://docs.cozythemes.com/cozy-blocks/toggle-content/" target="_blank"
								rel="noopener"><?php esc_html_e( 'Docs', 'cozy-addons' ); ?></a>
						</p>
					</div>
				</div>
				<div class="toggle-switcher-wrap">
					...
					?>
					<input type="checkbox" class="cozy-block-active" name="toggle-content"
						id="cozy-block--toggle-content"
						<?php echo cozy_addons_premium_access() && ( '1' === $checked || '' == $checked ) ? 'checked' : ''; ?>>
					<?php
					$classes   = array();
					$classes[] = 'toggle-switcher';
		...
		<ul id="woocommerce-blocks" class="blocks-list grid-layout cols-3">
			<li class="block-item flex-layout">
					...
					<i class="block-icon">
						<svg width="26" height="26" viewBox="0 0 54 50" fill="none" xmlns="http://www.w3.org/2000/svg">
							<path
								d="M38.3096 3.00391C44.7939 3.16811 50 8.47608 50 15V25H48V15C48 9.64975 43.7983 5.28054 38.5146 5.0127L38 5H12C6.47715 5 2 9.47715 2 15V35C2 40.5228 6.47715 45 12 45H31V47H12C5.47608 47 0.168106 41.7939 0.00390625 35.3096L0 35V15C0 8.47608 5.20608 3.16811 11.6904 3.00391L12 3H38L38.3096 3.00391Z"
								fill="currentColor" />
							<path d="M31.5 25H25.0714H19.5" stroke="currentColor" stroke-width="2"
								stroke-linecap="round" />
							<path d="M25 19V25.4286V31" stroke="currentColor" stroke-width="2" stroke-linecap="round" />
							<path
								d="M40.25 40.25C41.6307 40.25 42.75 41.3693 42.75 42.75C42.75 44.1307 41.6307 45.25 40.25 45.25C38.8693 45.25 37.75 44.1307 37.75 42.75C37.75 41.3693 38.8693 40.25 40.25 40.25ZM49.25 40.25C50.6307 40.25 51.75 41.3693 51.75 42.75C51.75 44.1307 50.6307 45.25 49.25 45.25C47.8693 45.25 46.75 44.1307 46.75 42.75C46.75 41.3693 47.8693 40.25 49.25 40.25ZM49.25 41.75C48.6977 41.75 48.25 42.1977 48.25 42.75C48.25 43.3023 48.6977 43.75 49.25 43.75C49.8023 43.75 50.25 43.3023 50.25 42.75C50.25 42.1977 49.8023 41.75 49.25 41.75ZM40.25 41.75C39.6977 41.75 39.25 42.1977 39.25 42.75C39.25 43.3023 39.6977 43.75 40.25 43.75C40.8023 43.75 41.25 43.3023 41.25 42.75C41.25 42.1977 40.8023 41.75 40.25 41.75ZM37.4814 27.584L38.0303 30H52.8662C53.5491 30.0003 54.0504 30.6421 53.8848 31.3047L52.0342 38.7051C51.9172 39.1723 51.4973 39.5 51.0156 39.5H39.4893C38.9991 39.4999 38.5745 39.1606 38.4658 38.6826L36.7002 30.916L36.1514 28.5H33.75C33.3358 28.5 33 28.1642 33 27.75C33 27.3358 33.3358 27 33.75 27H37.3486L37.4814 27.584ZM39.8486 38H50.6641L52.29 31.5H38.3711L39.8486 38Z"
								fill="currentColor" />
						</svg>
					</i>
					<div>
						...
						<p class="block-helper-links">
							<a href="https://cozyblock.cozythemes.com/product-add-to-cart-woocommerce-block/"
								target="_blank" rel="noopener"><?php esc_html_e( 'Demo', 'cozy-addons' ); ?></a>
							<span class="link-separator">
								<svg width="2" height="2" viewBox="0 0 2 2" fill="none"
									xmlns="http://www.w3.org/2000/svg">
							...
							<a href="https://docs.cozythemes.com/cozy-blocks/add-to-cart/" target="_blank"
								rel="noopener"><?php esc_html_e( 'Docs', 'cozy-addons' ); ?></a>
						</p>
					</div>
				</div>
				<div class="toggle-switcher-wrap">
					...
					?>
					<input type="checkbox" class="cozy-block-active" name="add-to-cart" id="cozy-block--add-to-cart"
						<?php echo \CozyAddons\Helpers\Utils::is_woocommerce_active() && ( '1' === $checked || '' == $checked ) ? 'checked' : ''; ?>>
					<?php
					$classes   = array();
					$classes[] = 'toggle-switcher';
					$classes[] = ! \CozyAddons\Helpers\Utils::is_woocommerce_active() ? 'has-tooltip is-disabled' : '';
					?>
					<span class="<?php echo esc_attr( implode( ' ', $classes ) ); ?>"></span>
					<?php if ( ! \CozyAddons\Helpers\Utils::is_woocommerce_active() ) { ?>
					<div class="cozy-block-upsell-tooltip">
						<a class="activate-plugin" data-plugins="woocommerce"
							href="#"><?php esc_html_e( 'Install & Activate WooCommerce', 'cozy-addons' ); ?></a>
						<?php esc_html_e( ' to use this feature!', 'cozy-addons' ); ?>
					</div>
					<?php } ?>
				</div>
			...
			<li class="block-item flex-layout">
				<div class="flex-layout">
					...
					<div>
						...
						<p class="block-helper-links">
							<a href="https://cozyblock.cozythemes.com/featured-product-woocommerce-block/"
								target="_blank" rel="noopener"><?php esc_html_e( 'Demo', 'cozy-addons' ); ?></a>
							<span class="link-separator">
								<svg width="2" height="2" viewBox="0 0 2 2" fill="none"
									xmlns="http://www.w3.org/2000/svg">
							...
							<a href="https://docs.cozythemes.com/cozy-blocks/featured-product/" target="_blank"
								rel="noopener"><?php esc_html_e( 'Docs', 'cozy-addons' ); ?></a>
						</p>
					</div>
				</div>
				<div class="toggle-switcher-wrap">
					...
					?>
					<input type="checkbox" class="cozy-block-active" name="featured-product"
						id="cozy-block--featured-product"
						<?php echo \CozyAddons\Helpers\Utils::is_woocommerce_active() && cozy_addons_premium_access() && ( '1' === $checked || '' == $checked ) ? 'checked' : ''; ?>>
					<?php
					$classes   = array();
					$classes[] = 'toggle-switcher';
					$classes[] = ! \CozyAddons\Helpers\Utils::is_woocommerce_active() || ! cozy_addons_premium_access() ? 'has-tooltip is-disabled' : '';
					?>
					<span class="<?php echo esc_attr( implode( ' ', $classes ) ); ?>"></span>
					<?php if ( ! \CozyAddons\Helpers\Utils::is_woocommerce_active() ) { ?>
					<div class="cozy-block-upsell-tooltip">
						...
						<?php
					} elseif ( ! cozy_addons_premium_access() ) {
						?>
					<div class="cozy-block-upsell-tooltip">
						<a href="https://cozythemes.com/pricing-and-plans" target="_blank"
							rel="noopener"><?php esc_html_e( 'Upgrade to Pro', 'cozy-addons' ); ?></a>
			...
			<li class="block-item flex-layout">
				<div class="flex-layout">
					<i class="block-icon">
						<svg width="26" height="26" viewBox="0 0 48 50" fill="none" xmlns="http://www.w3.org/2000/svg">
							...
							<rect x="20" y="2.5" width="8" height="4" rx="2" fill="currentColor" />
							<rect x="29" y="2.5" width="8" height="4" rx="2" fill="currentColor" />
						</svg>
					...
					<div>
						...
						<p class="block-helper-links">
							<a href="https://cozyblock.cozythemes.com/featured-products-tab-woocommerce-block/"
								target="_blank" rel="noopener"><?php esc_html_e( 'Demo', 'cozy-addons' ); ?></a>
							<span class="link-separator">
								<svg width="2" height="2" viewBox="0 0 2 2" fill="none"
									xmlns="http://www.w3.org/2000/svg">
							...
							<a href="https://docs.cozythemes.com/cozy-blocks/featured-product-tabs/" target="_blank"
								rel="noopener"><?php esc_html_e( 'Docs', 'cozy-addons' ); ?></a>
						</p>
					</div>
				</div>
				<div class="toggle-switcher-wrap">
					...
					?>
					<input type="checkbox" class="cozy-block-active" name="featured-product-tabs"
						id="cozy-block--featured-product-tabs"
						<?php echo \CozyAddons\Helpers\Utils::is_woocommerce_active() && cozy_addons_premium_access() && ( '1' === $checked || '' == $checked ) ? 'checked' : ''; ?>>
					<?php
					$classes   = array();
					$classes[] = 'toggle-switcher';
			...
			<li class="block-item flex-layout">
				<div class="flex-layout">
					...
					<div>
						...
						<p class="block-helper-links">
							<a href="https://cozyblock.cozythemes.com/product-categories-woocommerce-block/"
								target="_blank" rel="noopener"><?php esc_html_e( 'Demo', 'cozy-addons' ); ?></a>
							<span class="link-separator">
								<svg width="2" height="2" viewBox="0 0 2 2" fill="none"
									xmlns="http://www.w3.org/2000/svg">
							...
							<a href="https://docs.cozythemes.com/cozy-blocks/product-category/" target="_blank"
								rel="noopener"><?php esc_html_e( 'Docs', 'cozy-addons' ); ?></a>
						</p>
					</div>
				</div>
				<div class="toggle-switcher-wrap">
					...
					?>
					<input type="checkbox" class="cozy-block-active" name="product-category"
						id="cozy-block--product-category"
						<?php echo \CozyAddons\Helpers\Utils::is_woocommerce_active() && ( '1' === $checked || '' == $checked ) ? 'checked' : ''; ?>>
					<?php
					$classes   = array();
					$classes[] = 'toggle-switcher';
			...
			<li class="block-item flex-layout">
				<div class="flex-layout">
					<i class="block-icon">
						<svg width="26" height="26" viewBox="0 0 48 50" fill="none" xmlns="http://www.w3.org/2000/svg">
							<path
								d="M36 1C42.6274 1 48 6.37258 48 13V37C48 43.6274 42.6274 49 36 49H12C5.37258 49 0 43.6274 0 37V13C0 6.37258 5.37258 1 12 1H36ZM12 3C6.47715 3 2 7.47715 2 13V37C2 42.5228 6.47715 47 12 47H36C41.5228 47 46 42.5228 46 37V13C46 7.47715 41.5228 3 36 3H12Z"
								fill="currentColor" />
							<rect x="9.05469" y="14.0547" width="11.447" height="11.447" stroke="currentColor" />
							<path d="M19.4463 12.9707H7.97266V24.4463H7V12H19.4463V12.9707Z" fill="currentColor" />
							<path
								d="M13.1074 21.4658C13.5723 21.4658 13.949 21.8428 13.9492 22.3076C13.9492 22.7726 13.5724 23.1494 13.1074 23.1494C12.6426 23.1492 12.2656 22.7725 12.2656 22.3076C12.2658 21.8429 12.6427 21.466 13.1074 21.4658ZM16.1396 21.4658C16.6043 21.466 16.9813 21.8429 16.9814 22.3076C16.9814 22.7725 16.6045 23.1492 16.1396 23.1494C15.6747 23.1493 15.2979 22.7726 15.2979 22.3076C15.298 21.8428 15.6748 21.4659 16.1396 21.4658ZM16.1396 21.9707C15.9538 21.9708 15.8029 22.1218 15.8027 22.3076C15.8027 22.4936 15.9537 22.6445 16.1396 22.6445C16.3255 22.6443 16.4766 22.4935 16.4766 22.3076C16.4764 22.1219 16.3253 21.9709 16.1396 21.9707ZM13.1074 21.9707C12.9217 21.9709 12.7707 22.1219 12.7705 22.3076C12.7705 22.4935 12.9216 22.6443 13.1074 22.6445C13.2934 22.6445 13.4443 22.4936 13.4443 22.3076C13.4441 22.1218 13.2933 21.9707 13.1074 21.9707ZM12.1758 17.2012L12.3604 18.0146H17.3564C17.5863 18.0148 17.7558 18.2311 17.7002 18.4541L17.0771 20.9463C17.0378 21.1036 16.8955 21.2138 16.7334 21.2139H12.8516C12.6866 21.2137 12.5434 21.0994 12.5068 20.9385L11.9131 18.3232L11.7275 17.5098H10.9189C10.7794 17.5098 10.666 17.3963 10.666 17.2568C10.6661 17.1174 10.7795 17.0039 10.9189 17.0039H12.1309L12.1758 17.2012ZM12.9727 20.709H16.6152L17.1631 18.5195H12.4756L12.9727 20.709Z"
								fill="currentColor" />
							...
							<rect x="26.0566" y="14.0547" width="11.447" height="11.447" stroke="currentColor" />
							<path d="M36.4482 12.9707H24.9746V24.4463H24.002V12H36.4482V12.9707Z" fill="currentColor" />
							<path
								d="M30.1094 21.4658C30.5743 21.4658 30.951 21.8428 30.9512 22.3076C30.9512 22.7726 30.5744 23.1494 30.1094 23.1494C29.6446 23.1492 29.2676 22.7725 29.2676 22.3076C29.2678 21.8429 29.6447 21.466 30.1094 21.4658ZM33.1416 21.4658C33.6063 21.466 33.9832 21.8429 33.9834 22.3076C33.9834 22.7725 33.6064 23.1492 33.1416 23.1494C32.6767 23.1493 32.2998 22.7726 32.2998 22.3076C32.3 21.8428 32.6768 21.4659 33.1416 21.4658ZM33.1416 21.9707C32.9558 21.9708 32.8049 22.1218 32.8047 22.3076C32.8047 22.4936 32.9557 22.6445 33.1416 22.6445C33.3274 22.6443 33.4785 22.4935 33.4785 22.3076C33.4783 22.1219 33.3273 21.9709 33.1416 21.9707ZM30.1094 21.9707C29.9237 21.9709 29.7727 22.1219 29.7725 22.3076C29.7725 22.4935 29.9236 22.6443 30.1094 22.6445C30.2954 22.6445 30.4463 22.4936 30.4463 22.3076C30.4461 22.1218 30.2953 21.9707 30.1094 21.9707ZM29.1777 17.2012L29.3623 18.0146H34.3584C34.5883 18.0148 34.7578 18.2311 34.7021 18.4541L34.0791 20.9463C34.0397 21.1036 33.8975 21.2138 33.7354 21.2139H29.8535C29.6885 21.2137 29.5454 21.0994 29.5088 20.9385L28.915 18.3232L28.7295 17.5098H27.9209C27.7814 17.5098 27.668 17.3963 27.668 17.2568C27.6681 17.1174 27.7815 17.0039 27.9209 17.0039H29.1328L29.1777 17.2012ZM29.9746 20.709H33.6172L34.165 18.5195H29.4775L29.9746 20.709Z"
								fill="currentColor" />
							...
							<rect x="22.5" y="38" width="2" height="2" rx="1" fill="currentColor" />
					...
					<div>
						...
						<p class="block-helper-links">
							<a href="https://cozyblock.cozythemes.com/product-carousel-woocommerce-block/"
								target="_blank" rel="noopener"><?php esc_html_e( 'Demo', 'cozy-addons' ); ?></a>
							<span class="link-separator">
								<svg width="2" height="2" viewBox="0 0 2 2" fill="none"
									xmlns="http://www.w3.org/2000/svg">
							...
							<a href="https://docs.cozythemes.com/cozy-blocks/product-grid-carousel/" target="_blank"
								rel="noopener"><?php esc_html_e( 'Docs', 'cozy-addons' ); ?></a>
						</p>
					</div>
				</div>
				<div class="toggle-switcher-wrap">
					...
					?>
					<input type="checkbox" class="cozy-block-active" name="product-carousel"
						id="cozy-block--product-carousel"
						<?php echo \CozyAddons\Helpers\Utils::is_woocommerce_active() && ( '1' === $checked || '' == $checked ) ? 'checked' : ''; ?>>
					<?php
					$classes   = array();
					$classes[] = 'toggle-switcher';
			...
			<li class="block-item flex-layout">
				<div class="flex-layout">
					...
					<div>
						...
						<p class="block-helper-links">
							<a href="https://cozyblock.cozythemes.com/all-product-reviews-woocommerce-block/"
								target="_blank" rel="noopener"><?php esc_html_e( 'Demo', 'cozy-addons' ); ?></a>
							<span class="link-separator">
								<svg width="2" height="2" viewBox="0 0 2 2" fill="none"
									xmlns="http://www.w3.org/2000/svg">
							...
							<a href="https://docs.cozythemes.com/cozy-blocks/all-product-review/" target="_blank"
								rel="noopener"><?php esc_html_e( 'Docs', 'cozy-addons' ); ?></a>
						</p>
					</div>
				</div>
				<div class="toggle-switcher-wrap">
					...
					?>
					<input type="checkbox" class="cozy-block-active" name="product-review"
						id="cozy-block--product-review"
						<?php echo \CozyAddons\Helpers\Utils::is_woocommerce_active() && ( '1' === $checked || '' == $checked ) ? 'checked' : ''; ?>>
					<?php
					$classes   = array();
					$classes[] = 'toggle-switcher';
			...
			<li class="block-item flex-layout">
				<div class="flex-layout">
					<i class="block-icon">
						<svg width="26" height="26" viewBox="0 0 64 50" fill="none" xmlns="http://www.w3.org/2000/svg">
							...
							<rect x="29.9883" y="45.5" width="3" height="3" rx="1.5" fill="currentColor" />
							<rect x="35.9883" y="45.5" width="3" height="3" rx="1.5" fill="#CAD5F2" />
							<rect x="16.4937" y="16.4937" width="13.8969" height="13.8969" stroke="currentColor"
								stroke-width="1.21403" />
							<path d="M28.1104 14.002H14.001V28.1104H13V13H28.1104V14.002Z" fill="currentColor" />
							<path
								...
								fill="currentColor" />
							<line x1="34.6406" y1="21.393" x2="40.7108" y2="21.393" stroke="currentColor"
								stroke-width="1.21403" />
							<line x1="41.9258" y1="21.393" x2="47.9959" y2="21.393" stroke="currentColor"
								stroke-width="1.21403" />
							<line x1="34.6406" y1="17.7524" x2="50.423" y2="17.7524" stroke="currentColor"
								stroke-width="1.21403" />
							<line x1="34.6406" y1="25.0336" x2="44.3528" y2="25.0336" stroke="currentColor"
								stroke-width="1.21403" />
						</svg>
					</i>
					<div>
						...
						<p class="block-helper-links">
							<a href="https://cozyblock.cozythemes.com/product-slider-woocommerce-block/" target="_blank"
								rel="noopener"><?php esc_html_e( 'Demo', 'cozy-addons' ); ?></a>
							<span class="link-separator">
								<svg width="2" height="2" viewBox="0 0 2 2" fill="none"
									xmlns="http://www.w3.org/2000/svg">
							...
							<a href="https://docs.cozythemes.com/cozy-blocks/product-slider/" target="_blank"
								rel="noopener"><?php esc_html_e( 'Docs', 'cozy-addons' ); ?></a>
						</p>
					</div>
				</div>
				<div class="toggle-switcher-wrap">
					...
					?>
					<input type="checkbox" class="cozy-block-active" name="product-slider"
						id="cozy-block--product-slider"
						<?php echo \CozyAddons\Helpers\Utils::is_woocommerce_active() && cozy_addons_premium_access() && ( '1' === $checked || '' == $checked ) ? 'checked' : ''; ?>>
					<?php
					$classes   = array();
					$classes[] = 'toggle-switcher';
			...
			<li class="block-item flex-layout">
				<div class="flex-layout">
					<i class="block-icon">
						<svg width="26" height="26" viewBox="0 0 51 50" fill="none" xmlns="http://www.w3.org/2000/svg">
							<path
								...
								fill="currentColor" />
							<rect x="12.0547" y="19.6133" width="11.447" height="11.447" stroke="currentColor" />
							<path d="M22.4463 18.5293H10.9727V30.0049H10V17.5586H22.4463V18.5293Z"
								fill="currentColor" />
							<path
							...
							<rect x="29.0566" y="19.6133" width="11.447" height="11.447" stroke="currentColor" />
							<path d="M39.4482 18.5293H27.9746V30.0049H27.002V17.5586H39.4482V18.5293Z"
								fill="currentColor" />
							<path
					...
					<div>
						...
						<p class="block-helper-links">
							<a href="https://cozyblock.cozythemes.com/product-showcase-tabs-woocommerce-block/"
								target="_blank" rel="noopener"><?php esc_html_e( 'Demo', 'cozy-addons' ); ?></a>
							<span class="link-separator">
								<svg width="2" height="2" viewBox="0 0 2 2" fill="none"
									xmlns="http://www.w3.org/2000/svg">
							...
							<a href="https://docs.cozythemes.com/cozy-blocks/product-showcase-tabs/" target="_blank"
								rel="noopener"><?php esc_html_e( 'Docs', 'cozy-addons' ); ?></a>
						</p>
					</div>
				</div>
				<div class="toggle-switcher-wrap">
					...
					?>
					<input type="checkbox" class="cozy-block-active" name="product-tab" id="cozy-block--product-tab"
						<?php echo \CozyAddons\Helpers\Utils::is_woocommerce_active() && cozy_addons_premium_access() && ( '1' === $checked || '' == $checked ) ? 'checked' : ''; ?>>
					<?php
					$classes   = array();
					$classes[] = 'toggle-switcher';
			...
			<li class="block-item flex-layout">
				<div class="flex-layout">
					<i class="block-icon">
						<svg width="26" height="26" viewBox="0 0 52 50" fill="none" xmlns="http://www.w3.org/2000/svg">
							<circle cx="17.3817" cy="20.3817" r="16.3817" stroke="currentColor" stroke-width="2" />
							<path d="M30.1895 30.9023L48.4806 46.094" stroke="currentColor" stroke-width="2"
								stroke-linecap="round" />
							<path d="M39.0215 38.3555L49.1182 47.0002" stroke="currentColor" stroke-width="3.86261"
								stroke-linecap="round" />
							<path
					...
					<div>
						...
						<p class="block-helper-links">
							<a href="https://cozyblock.cozythemes.com/product-quick-view-woocommerce-block/"
								target="_blank" rel="noopener"><?php esc_html_e( 'Demo', 'cozy-addons' ); ?></a>
							<span class="link-separator">
								<svg width="2" height="2" viewBox="0 0 2 2" fill="none"
									xmlns="http://www.w3.org/2000/svg">
							...
							<a href="https://docs.cozythemes.com/cozy-blocks/quick-view/" target="_blank"
								rel="noopener"><?php esc_html_e( 'Docs', 'cozy-addons' ); ?></a>
						</p>
					</div>
				</div>
				<div class="toggle-switcher-wrap">
					...
					?>
					<input type="checkbox" class="cozy-block-active" name="quick-view" id="cozy-block--quick-view"
						<?php echo \CozyAddons\Helpers\Utils::is_woocommerce_active() && cozy_addons_premium_access() && ( '1' === $checked || '' == $checked ) ? 'checked' : ''; ?>>
					<?php
					$classes   = array();
					$classes[] = 'toggle-switcher';
			...
			<li class="block-item flex-layout">
					...
					<i class="block-icon">
						<svg width="26" height="26" viewBox="0 0 47 50" fill="none" xmlns="http://www.w3.org/2000/svg">
							<path
								...
								fill="currentColor" />
							<circle cx="36.5" cy="33.5" r="7.5" stroke="currentColor" stroke-width="2" />
							<path d="M40 34H36.7857H34" stroke="currentColor" stroke-linecap="round" />
							<path d="M36.75 31V34.2143V37" stroke="currentColor" stroke-linecap="round" />
						</svg>
					</i>
					<div>
						<h4 class="block-title has-icon">
						...
						<p class="block-helper-links">
							<a href="https://cozyblock.cozythemes.com/product-wishlist-woocommerce-block/"
								target="_blank" rel="noopener"><?php esc_html_e( 'Demo', 'cozy-addons' ); ?></a>
							<span class="link-separator">
								<svg width="2" height="2" viewBox="0 0 2 2" fill="none"
									xmlns="http://www.w3.org/2000/svg">
							...
							<a href="https://docs.cozythemes.com/cozy-blocks/wishlist/" target="_blank"
								rel="noopener"><?php esc_html_e( 'Docs', 'cozy-addons' ); ?></a>
						</p>
					</div>
				</div>
				<div class="toggle-switcher-wrap">
					...
					?>
					<input type="checkbox" class="cozy-block-active" name="wishlist" id="cozy-block--wishlist"
						<?php echo \CozyAddons\Helpers\Utils::is_woocommerce_active() && cozy_addons_premium_access() && ( '1' === $checked || '' == $checked ) ? 'checked' : ''; ?>>
					<?php
					$classes   = array();
					$classes[] = 'toggle-switcher';
		...
		<ul id="post-blocks" class="blocks-list grid-layout cols-3">
				...
				<div class="flex-layout">
					...
					<div>
						...
						<p class="block-helper-links">
							...
							<a href="https://docs.cozythemes.com/cozy-blocks/social-shares/" target="_blank"
								rel="noopener"><?php esc_html_e( 'Docs', 'cozy-addons' ); ?></a>
						</p>
					</div>
				</div>
				...
				<div class="flex-layout">
					...
					<div>
						...
						<p class="block-helper-links">
							...
							<a href="https://docs.cozythemes.com/cozy-blocks/advertisement/" target="_blank"
								rel="noopener"><?php esc_html_e( 'Docs', 'cozy-addons' ); ?></a>
						</p>
					</div>
				</div>
			...
			<li class="block-item flex-layout">
				<div class="flex-layout">
					<i class="block-icon">
						<svg width="26" height="26" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
							<rect x="1" y="1" width="21" height="21" rx="4" stroke="currentColor" stroke-width="2" />
							<rect x="1" y="28" width="21" height="21" rx="4" stroke="currentColor" stroke-width="2" />
							<rect x="28" y="1" width="21" height="21" rx="4" stroke="currentColor" stroke-width="2" />
							<path d="M27.4922 30H48.4922" stroke="currentColor" stroke-width="2"
								stroke-linecap="round" />
							<path d="M38.4922 38L48.4922 38" stroke="currentColor" stroke-width="2"
								stroke-linecap="round" />
							<path d="M27.4922 46H48.4922" stroke="currentColor" stroke-width="2"
								stroke-linecap="round" />
						</svg>
					</i>
					<div>
						...
						<p class="block-helper-links">
							<a href="https://cozyblock.cozythemes.com/advanced-categories-gutenberg-block/"
								target="_blank" rel="noopener"><?php esc_html_e( 'Demo', 'cozy-addons' ); ?></a>
							<span class="link-separator">
								<svg width="2" height="2" viewBox="0 0 2 2" fill="none"
									xmlns="http://www.w3.org/2000/svg">
							...
							<a href="https://docs.cozythemes.com/cozy-blocks/advanced-categories/" target="_blank"
								rel="noopener"><?php esc_html_e( 'Docs', 'cozy-addons' ); ?></a>
						</p>
					</div>
				</div>
				<div class="toggle-switcher-wrap">
					...
					?>
					<input type="checkbox" class="cozy-block-active" name="advanced-categories"
						id="cozy-block--advanced-categories"
						<?php echo cozy_addons_premium_access() && ( '1' === $checked || '' == $checked ) ? 'checked' : ''; ?>>
					<?php
					$classes   = array();
					$classes[] = 'toggle-switcher';
			...
			<li class="block-item flex-layout">
				<div class="flex-layout">
					<i class="block-icon">
						<svg width="26" height="26" viewBox="0 0 51 50" fill="none" xmlns="http://www.w3.org/2000/svg">
							<path
								...
								fill="currentColor" />
							<rect x="25.25" y="15.8086" width="8.5" height="7.5" rx="1.75" stroke="currentColor"
								stroke-width="0.5" />
							<path d="M31.059 18.6328L31.7765 20.8232H28L29.0763 19.2559L29.8694 20.1245L31.059 18.6328Z"
								fill="currentColor" />
							<circle cx="28.3217" cy="18.8607" r="0.302122" fill="currentColor" />
							...
							<rect x="25.25" y="24.8086" width="8.5" height="7.5" rx="1.75" stroke="currentColor"
								stroke-width="0.5" />
							<path d="M31.059 27.6328L31.7765 29.8232H28L29.0763 28.2559L29.8694 29.1245L31.059 27.6328Z"
								fill="currentColor" />
							<circle cx="28.3217" cy="27.8607" r="0.302122" fill="currentColor" />
							...
							<rect x="25.25" y="33.8086" width="8.5" height="7.5" rx="1.75" stroke="currentColor"
								stroke-width="0.5" />
							<path d="M31.059 36.6328L31.7765 38.8232H28L29.0763 37.2559L29.8694 38.1245L31.059 36.6328Z"
								fill="currentColor" />
							<circle cx="28.3217" cy="36.8607" r="0.302122" fill="currentColor" />
					...
					<div>
						...
						<p class="block-helper-links">
							<a href="https://cozyblock.cozythemes.com/categorized-post-tabs-gutenberg-block/"
								target="_blank" rel="noopener"><?php esc_html_e( 'Demo', 'cozy-addons' ); ?></a>
							<span class="link-separator">
								<svg width="2" height="2" viewBox="0 0 2 2" fill="none"
									xmlns="http://www.w3.org/2000/svg">
							...
							<a href="https://docs.cozythemes.com/cozy-blocks/categorized-post-tabs/" target="_blank"
								rel="noopener"><?php esc_html_e( 'Docs', 'cozy-addons' ); ?></a>
						</p>
					</div>
				</div>
				<div class="toggle-switcher-wrap">
					...
					?>
					<input type="checkbox" class="cozy-block-active" name="categorized-post-tabs"
						id="cozy-block--categorized-post-tabs"
						<?php echo cozy_addons_premium_access() && ( '1' === $checked || '' == $checked ) ? 'checked' : ''; ?>>
					<?php
					$classes   = array();
					$classes[] = 'toggle-switcher';
			...
			<li class="block-item flex-layout">
				<div class="flex-layout">
					<i class="block-icon">
						<svg width="26" height="26" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
							...
							<path d="M18.041 12.125L19.2235 15.7346H13L14.7737 13.1519L16.0806 14.5833L18.041 12.125Z"
								fill="currentColor" />
							<circle cx="13.5272" cy="12.4979" r="0.497878" fill="currentColor" />
							<line x1="10.5" y1="23.5" x2="15.5" y2="23.5" stroke="#A0C1FF" />
							<line x1="16.5" y1="23.5" x2="21.5" y2="23.5" stroke="#A0C1FF" />
							<line x1="10.5" y1="21.5" x2="23.5" y2="21.5" stroke="#A0C1FF" />
							<rect x="26.5" y="8.5" width="13" height="11" stroke="currentColor" />
							<path d="M34.041 12.125L35.2235 15.7346H29L30.7737 13.1519L32.0806 14.5833L34.041 12.125Z"
								fill="currentColor" />
							<circle cx="29.5272" cy="12.4979" r="0.497878" fill="currentColor" />
							<line x1="26.5" y1="23.5" x2="31.5" y2="23.5" stroke="#A0C1FF" />
							<line x1="32.5" y1="23.5" x2="37.5" y2="23.5" stroke="#A0C1FF" />
							<line x1="26.5" y1="21.5" x2="39.5" y2="21.5" stroke="#A0C1FF" />
							<rect x="10.5" y="27.5" width="13" height="11" stroke="currentColor" />
							<path d="M18.041 31.125L19.2235 34.7346H13L14.7737 32.1519L16.0806 33.5833L18.041 31.125Z"
								fill="currentColor" />
							<circle cx="13.5272" cy="31.4979" r="0.497878" fill="currentColor" />
							<line x1="10.5" y1="42.5" x2="15.5" y2="42.5" stroke="#A0C1FF" />
							<line x1="16.5" y1="42.5" x2="21.5" y2="42.5" stroke="#A0C1FF" />
							<line x1="10.5" y1="40.5" x2="23.5" y2="40.5" stroke="#A0C1FF" />
							<rect x="26.5" y="27.5" width="13" height="11" stroke="currentColor" />
							<path d="M34.041 31.125L35.2235 34.7346H29L30.7737 32.1519L32.0806 33.5833L34.041 31.125Z"
								fill="currentColor" />
							<circle cx="29.5272" cy="31.4979" r="0.497878" fill="currentColor" />
							<line x1="26.5" y1="42.5" x2="31.5" y2="42.5" stroke="#A0C1FF" />
							<line x1="32.5" y1="42.5" x2="37.5" y2="42.5" stroke="#A0C1FF" />
							<line x1="26.5" y1="40.5" x2="39.5" y2="40.5" stroke="#A0C1FF" />
						</svg>
					...
					<div>
						...
						<p class="block-helper-links">
							<a href="https://cozyblock.cozythemes.com/featured-post-gutenberg-block/" target="_blank"
								rel="noopener"><?php esc_html_e( 'Demo', 'cozy-addons' ); ?></a>
							<span class="link-separator">
								<svg width="2" height="2" viewBox="0 0 2 2" fill="none"
									xmlns="http://www.w3.org/2000/svg">
							...
							<a href="https://docs.cozythemes.com/cozy-blocks/featured-post/" target="_blank"
								rel="noopener"><?php esc_html_e( 'Docs', 'cozy-addons' ); ?></a>
						</p>
					</div>
				</div>
				<div class="toggle-switcher-wrap">
					...
					?>
					<input type="checkbox" class="cozy-block-active" name="featured-post" id="cozy-block--featured-post"
						<?php echo cozy_addons_premium_access() && ( '1' === $checked || '' == $checked ) ? 'checked' : ''; ?>>
					<?php
					$classes   = array();
					$classes[] = 'toggle-switcher';
			...
			<li class="block-item flex-layout">
				<div class="flex-layout">
					<i class="block-icon">
						<svg width="26" height="26" viewBox="0 0 51 50" fill="none" xmlns="http://www.w3.org/2000/svg">
							<path
								d="M28.8887 2.62109C30.6326 2.30402 32.367 3.22115 33.0869 4.84082L34.1016 7.12305C34.1061 7.13319 34.1091 7.14409 34.1133 7.1543H44.041C47.3547 7.1543 50.041 9.8406 50.041 13.1543V41.4424C50.0408 44.7559 47.3546 47.4424 44.041 47.4424H6C2.68653 47.4423 0.000257081 44.7558 0 41.4424V9.16602C0 5.85236 2.68637 3.16611 6 3.16602H10.5791C12.325 3.1661 13.9219 4.15149 14.7051 5.71191C15.149 6.59597 16.0537 7.15421 17.043 7.1543H17.1631C16.7434 5.06966 18.1108 3.00871 20.2422 2.62109C21.9861 2.30408 23.7205 3.22115 24.4404 4.84082L25.4551 7.12305C25.4596 7.13321 25.4626 7.14407 25.4668 7.1543H25.8096C25.3899 5.06968 26.7573 3.00872 28.8887 2.62109ZM6 5.16602C3.79094 5.16611 2 6.95693 2 9.16602V41.4424C2.00026 43.6512 3.7911 45.4423 6 45.4424H44.041C46.25 45.4424 48.0408 43.6513 48.041 41.4424V13.1543C48.041 10.9452 46.2501 9.1543 44.041 9.1543H17.043C15.2971 9.15421 13.7002 8.16876 12.917 6.6084C12.4731 5.72425 11.5684 5.16611 10.5791 5.16602H6ZM31.2598 5.65332C30.9145 4.87678 30.0822 4.43684 29.2461 4.58887C28.175 4.78392 27.5057 5.86035 27.8047 6.90723L27.875 7.1543H31.9268L31.2598 5.65332ZM22.6133 5.65332C22.2681 4.87678 21.4357 4.43691 20.5996 4.58887C19.5285 4.7839 18.8592 5.86032 19.1582 6.90723L19.2285 7.1543H23.2803L22.6133 5.65332Z"
								fill="currentColor" />
							<rect x="10.0195" y="14.5" width="14" height="11" stroke="currentColor" />
							<path
								d="M18.5605 18.125L19.743 21.7346H13.5195L15.2932 19.1519L16.6002 20.5833L18.5605 18.125Z"
								fill="currentColor" />
							<circle cx="14.0467" cy="18.4979" r="0.497878" fill="currentColor" />
							...
							<rect x="10.0195" y="28.5" width="14" height="11" stroke="currentColor" />
							<path
								d="M18.5605 32.125L19.743 35.7346H13.5195L15.2932 33.1519L16.6002 34.5833L18.5605 32.125Z"
								fill="currentColor" />
							<circle cx="14.0467" cy="32.4979" r="0.497878" fill="currentColor" />
					...
					<div>
						...
						<p class="block-helper-links">
							<a href="https://cozyblock.cozythemes.com/featured-post-tabs-gutenberg-block/"
								target="_blank" rel="noopener"><?php esc_html_e( 'Demo', 'cozy-addons' ); ?></a>
							<span class="link-separator">
								<svg width="2" height="2" viewBox="0 0 2 2" fill="none"
									xmlns="http://www.w3.org/2000/svg">
							...
							<a href="https://docs.cozythemes.com/cozy-blocks/featured-post-tabs/" target="_blank"
								rel="noopener"><?php esc_html_e( 'Docs', 'cozy-addons' ); ?></a>
						</p>
					</div>
				</div>
				<div class="toggle-switcher-wrap">
					...
					?>
					<input type="checkbox" class="cozy-block-active" name="featured-post-tabs"
						id="cozy-block--featured-post-tabs"
						<?php echo cozy_addons_premium_access() && ( '1' === $checked || '' == $checked ) ? 'checked' : ''; ?>>
					<?php
					$classes   = array();
					$classes[] = 'toggle-switcher';
			...
			<li class="block-item flex-layout">
				<div class="flex-layout">
					<i class="block-icon">
						<svg width="26" height="26" viewBox="0 0 48 50" fill="none" xmlns="http://www.w3.org/2000/svg">
							<path
								d="M36 1C42.6274 1 48 6.37258 48 13V37C48 43.6274 42.6274 49 36 49H12C5.37258 49 0 43.6274 0 37V13C0 6.37258 5.37258 1 12 1H36ZM12 3C6.47715 3 2 7.47715 2 13V37C2 42.5228 6.47715 47 12 47H36C41.5228 47 46 42.5228 46 37V13C46 7.47715 41.5228 3 36 3H12Z"
								fill="currentColor" />
							<rect x="6.40436" y="13.4044" width="13.209" height="12.1307" stroke="currentColor"
								stroke-width="0.808713" />
							<path
								d="M15.0159 17.8516L16.2451 21.6256H9.77539L11.6193 18.9252L12.9779 20.4218L15.0159 17.8516Z"
								fill="currentColor" />
							<circle cx="10.3145" cy="18.3907" r="0.539142" fill="currentColor" />
							<path d="M7.07812 27.9805H11.3913" stroke="currentColor" stroke-width="0.808713" />
							<path d="M12.4688 27.9805H17.321" stroke="currentColor" stroke-width="0.808713" />
							<path d="M7.07812 30.1406H18.9393" stroke="currentColor" stroke-width="0.808713" />
							<path d="M7.07812 32.3008H14.087" stroke="currentColor" stroke-width="0.808713" />
							<rect x="22.3346" y="13.3171" width="8.24374" height="6.97547" stroke="currentColor"
								stroke-width="0.634134" />
							<path
								d="M27.1166 15.6211L27.8664 17.9101H23.9199L25.0447 16.2723L25.8734 17.18L27.1166 15.6211Z"
								fill="currentColor" />
							<circle cx="24.2532" cy="15.8548" r="0.315721" fill="currentColor" />
							...
							<line x1="22.334" y1="22.2923" x2="30.5777" y2="22.2923" stroke="#A0C1FF"
								stroke-width="0.634134" />
							<rect x="32.4811" y="13.3171" width="8.24374" height="6.97547" stroke="currentColor"
								stroke-width="0.634134" />
							<path
								d="M37.2631 15.6211L38.0129 17.9101H34.0664L35.1912 16.2723L36.0199 17.18L37.2631 15.6211Z"
								fill="currentColor" />
							<circle cx="34.3997" cy="15.8548" r="0.315721" fill="currentColor" />
							...
							<line x1="32.4805" y1="22.2923" x2="40.7242" y2="22.2923" stroke="#A0C1FF"
								stroke-width="0.634134" />
							<rect x="22.3346" y="26.5319" width="8.24374" height="6.97547" stroke="currentColor"
								stroke-width="0.634134" />
							<path
								d="M27.1166 28.8359L27.8664 31.1249H23.9199L25.0447 29.4871L25.8734 30.3948L27.1166 28.8359Z"
								fill="currentColor" />
							<circle cx="24.2532" cy="29.0696" r="0.315721" fill="currentColor" />
							...
							<line x1="22.334" y1="35.5072" x2="30.5777" y2="35.5072" stroke="#A0C1FF"
								stroke-width="0.634134" />
							<rect x="32.4811" y="26.5319" width="8.24374" height="6.97547" stroke="currentColor"
								stroke-width="0.634134" />
							<path
								d="M37.2631 28.8359L38.0129 31.1249H34.0664L35.1912 29.4871L36.0199 30.3948L37.2631 28.8359Z"
								fill="currentColor" />
							<circle cx="34.3997" cy="29.0696" r="0.315721" fill="currentColor" />
					...
					<div>
						...
						<p class="block-helper-links">
							<a href="https://cozyblock.cozythemes.com/magazine-grid-gutenberg-block/" target="_blank"
								rel="noopener"><?php esc_html_e( 'Demo', 'cozy-addons' ); ?></a>
							<span class="link-separator">
								<svg width="2" height="2" viewBox="0 0 2 2" fill="none"
									xmlns="http://www.w3.org/2000/svg">
							...
							<a href="https://docs.cozythemes.com/cozy-blocks/magazine-grid/" target="_blank"
								rel="noopener"><?php esc_html_e( 'Docs', 'cozy-addons' ); ?></a>
						</p>
					</div>
				</div>
				<div class="toggle-switcher-wrap">
					...
					?>
					<input type="checkbox" class="cozy-block-active" name="magazine-grid" id="cozy-block--magazine-grid"
						<?php echo cozy_addons_premium_access() && ( '1' === $checked || '' == $checked ) ? 'checked' : ''; ?>>
					<?php
					$classes   = array();
					$classes[] = 'toggle-switcher';
			...
			<li class="block-item flex-layout">
				<div class="flex-layout">
					<i class="block-icon">
						<svg width="26" height="26" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
							<rect x="1" y="1" width="48" height="48" rx="11" stroke="currentColor" stroke-width="2" />
							<rect x="10" y="12.5" width="14" height="11" stroke="currentColor" />
							<path d="M18.541 16.125L19.7235 19.7346H13.5L15.2737 17.1519L16.5806 18.5833L18.541 16.125Z"
								fill="currentColor" />
							<circle cx="14.0272" cy="16.4979" r="0.497878" fill="currentColor" />
							...
							<rect x="26" y="26.5" width="14" height="11" stroke="currentColor" />
							<path d="M34.541 30.125L35.7235 33.7346H29.5L31.2737 31.1519L32.5806 32.5833L34.541 30.125Z"
								fill="currentColor" />
							<circle cx="30.0272" cy="30.4979" r="0.497878" fill="currentColor" />
						</svg>
					</i>
					<div>
						<h4 class="block-title has-icon">
						...
						<p class="block-helper-links">
							<a href="https://cozyblock.cozythemes.com/magazine-list-gutenberg-block/" target="_blank"
								rel="noopener"><?php esc_html_e( 'Demo', 'cozy-addons' ); ?></a>
							<span class="link-separator">
								<svg width="2" height="2" viewBox="0 0 2 2" fill="none"
									xmlns="http://www.w3.org/2000/svg">
							...
							<a href="https://docs.cozythemes.com/cozy-blocks/magazine-list/" target="_blank"
								rel="noopener"><?php esc_html_e( 'Docs', 'cozy-addons' ); ?></a>
						</p>
					</div>
				</div>
				<div class="toggle-switcher-wrap">
					...
					?>
					<input type="checkbox" class="cozy-block-active" name="magazine-list" id="cozy-block--magazine-list"
						<?php echo cozy_addons_premium_access() && ( '1' === $checked || '' == $checked ) ? 'checked' : ''; ?>>
					<?php
					$classes   = array();
					$classes[] = 'toggle-switcher';
			...
			<li class="block-item flex-layout">
				<div class="flex-layout">
					...
					<div>
						...
						<p class="block-helper-links">
							<a href="https://cozyblock.cozythemes.com/news-ticker-gutenberg-block/" target="_blank"
								rel="noopener"><?php esc_html_e( 'Demo', 'cozy-addons' ); ?></a>
							<span class="link-separator">
								<svg width="2" height="2" viewBox="0 0 2 2" fill="none"
									xmlns="http://www.w3.org/2000/svg">
							...
							<a href="https://docs.cozythemes.com/cozy-blocks/news-ticker/" target="_blank"
								rel="noopener"><?php esc_html_e( 'Docs', 'cozy-addons' ); ?></a>
						</p>
					</div>
				</div>
				<div class="toggle-switcher-wrap">
					...
					?>
					<input type="checkbox" class="cozy-block-active" name="news-ticker" id="cozy-block--news-ticker"
						<?php echo cozy_addons_premium_access() && ( '1' === $checked || '' == $checked ) ? 'checked' : ''; ?>>
					<?php
					$classes   = array();
					$classes[] = 'toggle-switcher';
			...
			<li class="block-item flex-layout">
				<div class="flex-layout">
					...
					<div>
						...
						<p class="block-helper-links">
							<a href="https://cozyblock.cozythemes.com/popular-post-gutenberg-block/" target="_blank"
								rel="noopener"><?php esc_html_e( 'Demo', 'cozy-addons' ); ?></a>
							<span class="link-separator">
								<svg width="2" height="2" viewBox="0 0 2 2" fill="none"
									xmlns="http://www.w3.org/2000/svg">
							...
							<a href="https://docs.cozythemes.com/cozy-blocks/popular-post/" target="_blank"
								rel="noopener"><?php esc_html_e( 'Docs', 'cozy-addons' ); ?></a>
						</p>
					</div>
				</div>
				<div class="toggle-switcher-wrap">
					...
					?>
					<input type="checkbox" class="cozy-block-active" name="popular-post" id="cozy-block--popular-post"
						<?php echo cozy_addons_premium_access() && ( '1' === $checked || '' == $checked ) ? 'checked' : ''; ?>>
					<?php
					$classes   = array();
					$classes[] = 'toggle-switcher';
				...
				<div class="flex-layout">
					<i class="block-icon">
						<svg width="26" height="26" viewBox="0 0 48 50" fill="none" xmlns="http://www.w3.org/2000/svg">
							...
							<path d="M19.4463 12.9707H7.97266V24.4463H7V12H19.4463V12.9707Z" fill="currentColor" />
							<path
								d="M16.707 19.1289L17.8895 22.7385H11.666L13.4397 20.1558L14.7466 21.5872L16.707 19.1289Z"
								fill="currentColor" />
							<circle cx="12.1932" cy="19.5018" r="0.497878" fill="currentColor" />
							...
							<path d="M36.4482 12.9707H24.9746V24.4463H24.002V12H36.4482V12.9707Z" fill="currentColor" />
							<path
								d="M33.709 19.1289L34.8914 22.7385H28.668L30.4417 20.1558L31.7486 21.5872L33.709 19.1289Z"
								fill="currentColor" />
							<circle cx="29.1951" cy="19.5018" r="0.497878" fill="currentColor" />
					...
					<div>
						<h4 class="block-title"><?php esc_html_e( 'Post Grid/Carousel', 'cozy-addons' ); ?></h4>
						<p class="block-helper-links">
							<a href="https://cozyblock.cozythemes.com/post-carousel-gutenberg-block/" target="_blank"
								rel="noopener"><?php esc_html_e( 'Demo', 'cozy-addons' ); ?></a>
							<span class="link-separator">
								<svg width="2" height="2" viewBox="0 0 2 2" fill="none"
									xmlns="http://www.w3.org/2000/svg">
							...
							<a href="https://docs.cozythemes.com/cozy-blocks/post-grid-carousel/" target="_blank"
								rel="noopener"><?php esc_html_e( 'Docs', 'cozy-addons' ); ?></a>
						</p>
					</div>
				</div>
			...
			<li class="block-item flex-layout">
				<div class="flex-layout">
					...
					<div>
						...
						<p class="block-helper-links">
							<a href="https://cozyblock.cozythemes.com/post-comments-gutenberg-block/" target="_blank"
								rel="noopener"><?php esc_html_e( 'Demo', 'cozy-addons' ); ?></a>
							<span class="link-separator">
								<svg width="2" height="2" viewBox="0 0 2 2" fill="none"
									xmlns="http://www.w3.org/2000/svg">
							...
							<a href="https://docs.cozythemes.com/cozy-blocks/post-comments/" target="_blank"
								rel="noopener"><?php esc_html_e( 'Docs', 'cozy-addons' ); ?></a>
						</p>
					</div>
				</div>
				<div class="toggle-switcher-wrap">
					...
					?>
					<input type="checkbox" class="cozy-block-active" name="post-comments" id="cozy-block--post-comments"
						<?php echo cozy_addons_premium_access() && ( '1' === $checked || '' == $checked ) ? 'checked' : ''; ?>>
					<?php
					$classes   = array();
					$classes[] = 'toggle-switcher';
			...
			<li class="block-item flex-layout">
				<div class="flex-layout">
					<i class="block-icon">
						<svg width="26" height="26" viewBox="0 0 51 50" fill="none" xmlns="http://www.w3.org/2000/svg">
							...
							<rect x="24.9902" y="44.5" width="3" height="3" rx="1.5" fill="currentColor" />
							...
							<path
								...
								fill="currentColor" />
							<rect x="13.0566" y="16.0547" width="11.447" height="11.447" stroke="currentColor" />
							<path d="M23.4482 14.9707H11.9746V26.4463H11.002V14H23.4482V14.9707Z" fill="currentColor" />
							<path
								d="M20.709 21.1289L21.8914 24.7385H15.668L17.4417 22.1558L18.7486 23.5872L20.709 21.1289Z"
								fill="currentColor" />
							<circle cx="16.1951" cy="21.5018" r="0.497878" fill="currentColor" />
							<line x1="28.0039" y1="20.5" x2="33.0039" y2="20.5" stroke="currentColor" />
							<line x1="34.0039" y1="20.5" x2="39.0039" y2="20.5" stroke="currentColor" />
							<line x1="28.0039" y1="17.5" x2="41.0039" y2="17.5" stroke="currentColor" />
							<line x1="28.0039" y1="23.5" x2="36.0039" y2="23.5" stroke="currentColor" />
						</svg>
					</i>
					<div>
						<h4 class="block-title has-icon">
						...
						<p class="block-helper-links">
							<a href="https://cozyblock.cozythemes.com/post-slider-gutenberg-block/" target="_blank"
								rel="noopener"><?php esc_html_e( 'Demo', 'cozy-addons' ); ?></a>
							<span class="link-separator">
								<svg width="2" height="2" viewBox="0 0 2 2" fill="none"
									xmlns="http://www.w3.org/2000/svg">
							...
							<a href="https://docs.cozythemes.com/cozy-blocks/post-slider/" target="_blank"
								rel="noopener"><?php esc_html_e( 'Docs', 'cozy-addons' ); ?></a>
						</p>
					</div>
				</div>
				<div class="toggle-switcher-wrap">
					...
					?>
					<input type="checkbox" class="cozy-block-active" name="post-slider" id="cozy-block--post-slider"
						<?php echo cozy_addons_premium_access() && ( '1' === $checked || '' == $checked ) ? 'checked' : ''; ?>>
					<?php
					$classes   = array();
					$classes[] = 'toggle-switcher';
			...
			<li class="block-item flex-layout">
				<div class="flex-layout">
					...
					<div>
						...
						<p class="block-helper-links">
							<a href="https://cozyblock.cozythemes.com/post-views-gutenberg-block/" target="_blank"
								rel="noopener"><?php esc_html_e( 'Demo', 'cozy-addons' ); ?></a>
							<span class="link-separator">
								<svg width="2" height="2" viewBox="0 0 2 2" fill="none"
									xmlns="http://www.w3.org/2000/svg">
							...
							<a href="https://docs.cozythemes.com/cozy-blocks/post-view/" target="_blank"
								rel="noopener"><?php esc_html_e( 'Docs', 'cozy-addons' ); ?></a>
						</p>
					</div>
				</div>
				<div class="toggle-switcher-wrap">
					...
					?>
					<input type="checkbox" class="cozy-block-active" name="post-views" id="cozy-block--post-views"
						<?php echo cozy_addons_premium_access() && ( '1' === $checked || '' == $checked ) ? 'checked' : ''; ?>>
					<?php
					$classes   = array();
					$classes[] = 'toggle-switcher';
			...
			<li class="block-item flex-layout">
				<div class="flex-layout">
					<i class="block-icon">
						<svg width="26" height="26" viewBox="0 0 56 50" fill="none" xmlns="http://www.w3.org/2000/svg">
							<rect x="0.75" y="7.85938" width="24.5" height="22.5" rx="5.25" stroke="currentColor"
								stroke-width="1.5" />
							<path d="M16.72 16.1094L19 23.1094H7L10.42 18.1008L12.94 20.8766L16.72 16.1094Z"
								fill="currentColor" />
							<circle cx="8" cy="17.1094" r="1" fill="currentColor" />
							<path d="M2 34.8906H10" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" />
							<path d="M12 34.8906H21" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" />
							<path d="M2 38.8906H24" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" />
							<path d="M2 42.8906H15" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" />
							<rect x="30.5332" y="7.85938" width="24.5" height="22.5" rx="5.25" stroke="currentColor"
								stroke-width="1.5" />
							<path
								d="M46.5032 16.1094L48.7832 23.1094H36.7832L40.2032 18.1008L42.7232 20.8766L46.5032 16.1094Z"
								fill="currentColor" />
							<circle cx="37.7832" cy="17.1094" r="1" fill="currentColor" />
							<path d="M31.7832 34.8906H39.7832" stroke="currentColor" stroke-width="1.5"
								stroke-linecap="round" />
							<path d="M41.7832 34.8906H50.7832" stroke="currentColor" stroke-width="1.5"
								stroke-linecap="round" />
							<path d="M31.7832 38.8906H53.7832" stroke="currentColor" stroke-width="1.5"
								stroke-linecap="round" />
							<path d="M31.7832 42.8906H44.7832" stroke="currentColor" stroke-width="1.5"
								stroke-linecap="round" />
						</svg>
					</i>
					<div>
						...
						<p class="block-helper-links">
							...
							<a href="https://docs.cozythemes.com/cozy-blocks/related-post/" target="_blank"
								rel="noopener"><?php esc_html_e( 'Docs', 'cozy-addons' ); ?></a>
						</p>
					</div>
				</div>
				<div class="toggle-switcher-wrap">
					...
					?>
					<input type="checkbox" class="cozy-block-active" name="related-post" id="cozy-block--related-post"
						<?php echo cozy_addons_premium_access() && ( '1' === $checked || '' == $checked ) ? 'checked' : ''; ?>>
					<?php
					$classes   = array();
					$classes[] = 'toggle-switcher';
			...
			<li class="block-item flex-layout">
				<div class="flex-layout">
					<i class="block-icon">
						<svg width="26" height="26" viewBox="0 0 48 50" fill="none" xmlns="http://www.w3.org/2000/svg">
							<path
								d="M36 1C42.6274 1 48 6.37258 48 13V37C48 43.6274 42.6274 49 36 49H12C5.37258 49 0 43.6274 0 37V13C0 6.37258 5.37258 1 12 1H36ZM12 3C6.47715 3 2 7.47715 2 13V37C2 42.5228 6.47715 47 12 47H36C41.5228 47 46 42.5228 46 37V13C46 7.47715 41.5228 3 36 3H12Z"
								fill="currentColor" />
							<rect x="8.5" y="12.5" width="14" height="11" rx="2.5" stroke="currentColor" />
							<path
							...
							<rect x="8.5" y="26.5" width="14" height="11" rx="2.5" stroke="currentColor" />
							<path
					...
					<div>
						...
						<p class="block-helper-links">
							<a href="https://cozyblock.cozythemes.com/trending-post-gutenberg-block/" target="_blank"
								rel="noopener"><?php esc_html_e( 'Demo', 'cozy-addons' ); ?></a>
							<span class="link-separator">
								<svg width="2" height="2" viewBox="0 0 2 2" fill="none"
									xmlns="http://www.w3.org/2000/svg">
							...
							<a href="https://docs.cozythemes.com/cozy-blocks/trending-post/" target="_blank"
								rel="noopener"><?php esc_html_e( 'Docs', 'cozy-addons' ); ?></a>
						</p>
					</div>
				</div>
				<div class="toggle-switcher-wrap">
					...
					?>
					<input type="checkbox" class="cozy-block-active" name="trending-post" id="cozy-block--trending-post"
						<?php echo cozy_addons_premium_access() && ( '1' === $checked || '' == $checked ) ? 'checked' : ''; ?>>
					<?php
					$classes   = array();
					$classes[] = 'toggle-switcher';
