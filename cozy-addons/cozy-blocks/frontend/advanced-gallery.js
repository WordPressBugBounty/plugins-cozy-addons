(function ($) {
  window["cozyBlockAdvancedGallery"] = (e) => {
    ...
    if (attributes.enableOptions.lightbox) {
      ...
      // Open Lightbox
      $(blockID + " .cozy-block-advanced-gallery__item").on(
        "click",
        function () {
          ...
          lightboxSlider.slideTo(parseInt(index), 0, false);
              ...
              success: function (response) {
                ...
                if (response.success && response.data) {
                  ...
                  $(blockID + " .cozy-block-advanced-gallery__item").on(
                    ...
                    function () {
                      $("body").addClass(
                        "cozy-block-advanced-gallery__overflow-hidden"
                      );
                      // Your click event logic here
                      var index = $(this).index();
                      ...
                      $(
                        blockID +
                          " .cozy-block-advanced-gallery__lightbox-wrapper"
                      ).removeClass("display-none");
                    }
                  );
                }
