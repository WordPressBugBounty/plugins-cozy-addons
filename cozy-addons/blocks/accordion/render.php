...
$container_styles = array(
	'desktop' => array(
		'padding' => isset( $attributes['containerStyles']['desktop']['padding'] ) ? cozy_render_TRBL( 'padding', $attributes['containerStyles']['desktop']['padding'] ) : '',
	),
	'tablet'  => array(
		'padding' => isset( $attributes['containerStyles']['tablet']['padding'] ) ? cozy_render_TRBL( 'padding', $attributes['containerStyles']['tablet']['padding'] ) : '',
	),
	'mobile'  => array(
		'padding' => isset( $attributes['containerStyles']['mobile']['padding'] ) ? cozy_render_TRBL( 'padding', $attributes['containerStyles']['mobile']['padding'] ) : '',
	),
	'border'  => isset( $attributes['containerStyles']['border'] ) ? cozy_render_TRBL( 'border', $attributes['containerStyles']['border'] ) : '',
	'radius'  => isset( $attributes['containerStyles']['radius'] ) ? cozy_addons_sanitize_dimension( $attributes['containerStyles']['radius'] ) : '',
	'gap'     => isset( $attributes['rowGap'] ) && ! empty( $attributes['rowGap'] ) ? cozy_addons_sanitize_dimension( $attributes['rowGap'] ) : '',
);
...
$search_styles = array(
	...
	'desktop'        => array(
		'font' => array(
			'size' => isset( $attributes['search']['desktop']['font']['size'] ) ? cozy_addons_sanitize_dimension( $attributes['search']['desktop']['font']['size'] ) : '',
		),
	),
	'tablet'         => array(
		'font' => array(
			'size' => isset( $attributes['search']['tablet']['font']['size'] ) ? cozy_addons_sanitize_dimension( $attributes['search']['tablet']['font']['size'] ) : '',
		),
	),
	'mobile'         => array(
		'font' => array(
			'size' => isset( $attributes['search']['mobile']['font']['size'] ) ? cozy_addons_sanitize_dimension( $attributes['search']['mobile']['font']['size'] ) : '',
		),
	),
	'font'           => array(
...
$cat_styles    = array(
	...
	'desktop'        => array(
		'font' => array(
			'size' => isset( $attributes['category']['desktop']['font']['size'] ) ? cozy_addons_sanitize_dimension( $attributes['category']['desktop']['font']['size'] ) : '',
		),
	),
	'tablet'         => array(
		'font' => array(
			'size' => isset( $attributes['category']['tablet']['font']['size'] ) ? cozy_addons_sanitize_dimension( $attributes['category']['tablet']['font']['size'] ) : '',
		),
	),
	'mobile'         => array(
		'font' => array(
			'size' => isset( $attributes['category']['mobile']['font']['size'] ) ? cozy_addons_sanitize_dimension( $attributes['category']['mobile']['font']['size'] ) : '',
		),
	),
	'font'           => array(
...
$item_styles = array(
	'desktop' => array(
		'padding' => isset( $attributes['accordionStyles']['desktop']['padding'] ) ? cozy_render_TRBL( 'padding', $attributes['accordionStyles']['desktop']['padding'] ) : '',
	),
	'tablet'  => array(
		'padding' => isset( $attributes['accordionStyles']['tablet']['padding'] ) ? cozy_render_TRBL( 'padding', $attributes['accordionStyles']['tablet']['padding'] ) : '',
	),
	'mobile'  => array(
		'padding' => isset( $attributes['accordionStyles']['mobile']['padding'] ) ? cozy_render_TRBL( 'padding', $attributes['accordionStyles']['mobile']['padding'] ) : '',
	),
	'border'  => isset( $attributes['accordionStyles']['border'] ) ? cozy_render_TRBL( 'border', $attributes['accordionStyles']['border'] ) : '',
	'radius'  => isset( $attributes['accordionStyles']['radius'] ) ? cozy_addons_sanitize_dimension( $attributes['accordionStyles']['radius'] ) : '',
);
$item_color  = array(
	'bg'            => isset( $attributes['accordionStyles']['bgColor'] ) ? esc_attr( $attributes['accordionStyles']['bgColor'] ) : '',
	'border_active' => isset( $attributes['accordionStyles']['borderColorActive'] ) ? esc_attr( $attributes['accordionStyles']['borderColorActive'] ) : '',
);
...
$title_styles = array(
	...
	'desktop'        => array(
		'font' => array( 'size' => isset( $attributes['titleTypography']['desktop']['font']['size'] ) ? cozy_addons_sanitize_dimension( $attributes['titleTypography']['desktop']['font']['size'] ) : '' ),
	),
	'tablet'         => array(
		'font' => array( 'size' => isset( $attributes['titleTypography']['tablet']['font']['size'] ) ? cozy_addons_sanitize_dimension( $attributes['titleTypography']['tablet']['font']['size'] ) : '' ),
	),
	'mobile'         => array(
		'font' => array( 'size' => isset( $attributes['titleTypography']['mobile']['font']['size'] ) ? cozy_addons_sanitize_dimension( $attributes['titleTypography']['mobile']['font']['size'] ) : '' ),
	),
	'font'           => array(
		'weight' => isset( $attributes['titleTypography']['font']['weight'] ) ? cozy_addons_sanitize_dimension( $attributes['titleTypography']['font']['weight'] ) : '',
		'family' => isset( $attributes['titleTypography']['font']['family'] ) ? esc_attr( sanitize_text_field( $attributes['titleTypography']['font']['family'] ) ) : '',
	),
	...
	'line_height'    => isset( $attributes['titleTypography']['lineHeight'] ) ? cozy_addons_sanitize_dimension( $attributes['titleTypography']['lineHeight'] ) : '',
	'letter_spacing' => isset( $attributes['titleTypography']['letterSpacing'] ) ? cozy_addons_sanitize_dimension( $attributes['titleTypography']['letterSpacing'] ) : '',
);
$title_color  = array(
...
$icon_styles = array(
	'desktop'       => array(
		'padding' => isset( $attributes['iconBoxStyles']['desktop']['padding'] ) ? cozy_render_TRBL( 'padding', $attributes['iconBoxStyles']['desktop']['padding'] ) : '',
		'width'   => isset( $attributes['iconBoxStyles']['desktop']['width'] ) ? $attributes['iconBoxStyles']['desktop']['width'] : '',
		'height'  => isset( $attributes['iconBoxStyles']['desktop']['height'] ) ? $attributes['iconBoxStyles']['desktop']['height'] : '',
	),
	'tablet'        => array(
		'padding' => isset( $attributes['iconBoxStyles']['tablet']['padding'] ) ? cozy_render_TRBL( 'padding', $attributes['iconBoxStyles']['tablet']['padding'] ) : '',
		'width'   => isset( $attributes['iconBoxStyles']['tablet']['width'] ) ? $attributes['iconBoxStyles']['tablet']['width'] : '',
		'height'  => isset( $attributes['iconBoxStyles']['tablet']['height'] ) ? $attributes['iconBoxStyles']['tablet']['height'] : '',
	),
	'mobile'        => array(
		'padding' => isset( $attributes['iconBoxStyles']['mobile']['padding'] ) ? cozy_render_TRBL( 'padding', $attributes['iconBoxStyles']['mobile']['padding'] ) : '',
		'width'   => isset( $attributes['iconBoxStyles']['mobile']['width'] ) ? $attributes['iconBoxStyles']['mobile']['width'] : '',
		'height'  => isset( $attributes['iconBoxStyles']['mobile']['height'] ) ? $attributes['iconBoxStyles']['mobile']['height'] : '',
	),
	'border'        => isset( $attributes['iconBoxStyles']['border'] ) ? cozy_render_TRBL( 'border', $attributes['iconBoxStyles']['border'] ) : '',
	'radius'        => isset( $attributes['iconBoxStyles']['radius'] ) ? cozy_addons_sanitize_dimension( $attributes['iconBoxStyles']['radius'] ) : '',
...
$block_styles = "
#$block_id {
	{$container_styles['desktop']['padding']}
	{$container_styles['border']}
	border-radius: {$container_styles['radius']};
    background-color: {$container_color['bg']};
}
@media only screen and (width <= 1024px) {
	#$block_id {
		{$container_styles['tablet']['padding']}
	}
}
@media only screen and (width <= 767px) {
	#$block_id {
		{$container_styles['mobile']['padding']}
	}
}
...
#$block_id #accordion-search {
	...
	font-size: {$search_styles['desktop']['font']['size']};
...
@media only screen and (width <= 1024px) {
	#$block_id #accordion-search {
		font-size: {$search_styles['tablet']['font']['size']};
	}
}
@media only screen and (width <= 767px) {
	#$block_id #accordion-search {
		font-size: {$search_styles['mobile']['font']['size']};
	}
}
...
#$block_id .category-tabs {
	gap: {$cat_styles['gap']};
	{$cat_styles['margin']}
	font-size: {$cat_styles['desktop']['font']['size']};
...
@media only screen and (width <= 1024px) {
	#$block_id .category-tabs {
		font-size: {$cat_styles['tablet']['font']['size']};
	}
}
@media only screen and (width <= 767px) {
	#$block_id .category-tabs {
		font-size: {$cat_styles['mobile']['font']['size']};
	}
}

#$block_id .cozy-accordion-wrapper {
    gap: {$container_styles['gap']}px;
}
...
#$block_id .cozy-block-accordion-item:has(.cozy-accordion-title.active) {
	border-color: {$item_color['border_active']};
}
@media only screen and (width <= 1024px) {
	#$block_id .cozy-block-accordion-item {
...
#$block_id .cozy-block-accordion-item .cozy-accordion-title * {
    ...
    font-size: {$title_styles['desktop']['font']['size']};
...
#$block_id .cozy-block-accordion-item .cozy-accordion-content {
    font-size: {$content_styles['desktop']['font']['size']};
...
@media only screen and (width <= 1024px) {
	#$block_id .cozy-block-accordion-item .cozy-accordion-title * {
		font-size: {$title_styles['tablet']['font']['size']};
	}
	#$block_id .cozy-block-accordion-item .cozy-accordion-content {
    	font-size: {$content_styles['tablet']['font']['size']};
	}
}
@media only screen and (width <= 767px) {
	#$block_id .cozy-block-accordion-item .cozy-accordion-title * {
		font-size: {$title_styles['mobile']['font']['size']};
	}
	#$block_id .cozy-block-accordion-item .cozy-accordion-content {
    	font-size: {$content_styles['mobile']['font']['size']};
	}
}
...
#$block_id .cozy-accordion-title .accordion-icon-wrapper {
	{$icon_styles['desktop']['padding']}
	width: {$icon_styles['desktop']['width']};
	height: {$icon_styles['desktop']['height']};
	{$icon_styles['border']}
    border-radius: {$icon_styles['radius']};
    background-color: {$icon_color['bg']};
}
#$block_id .cozy-accordion-title.active .accordion-icon-wrapper {
...
@media only screen and (width <= 1024px) {
	#$block_id .cozy-accordion-title .accordion-icon-wrapper {
		{$icon_styles['tablet']['padding']}
		width: {$icon_styles['tablet']['width']};
		height: {$icon_styles['tablet']['height']};
	}
}
@media only screen and (width <= 767px) {
	#$block_id .cozy-accordion-title .accordion-icon-wrapper {
		{$icon_styles['mobile']['padding']}
		width: {$icon_styles['mobile']['width']};
		height: {$icon_styles['mobile']['height']};
	}
}
";
...
if ( isset( $attributes['titleTypography']['font']['family'] ) && ! empty( $attributes['titleTypography']['font']['family'] ) ) {
	$font_families[] = esc_attr( sanitize_text_field( $attributes['titleTypography']['font']['family'] ) );
}
if ( isset( $attributes['typography']['font']['family'] ) && ! empty( $attributes['typography']['font']['family'] ) ) {
	$font_families[] = esc_attr( sanitize_text_field( $attributes['typography']['font']['family'] ) );
}
...
if ( cozy_addons_premium_access() && ! empty( $schema_main_entity ) ) {
	$schema = array(
