...
$toast_card = array(
	...
	'position' => array(
		'vertical'   => isset( $attributes['toast']['position']['vertical'] ) ? cozy_addons_sanitize_dimension( $attributes['toast']['position']['vertical'] ) : '',
		'horizontal' => isset( $attributes['toast']['position']['horizontal'] ) ? cozy_addons_sanitize_dimension( $attributes['toast']['position']['horizontal'] ) : '',
	),
);
...
$header_box = array(
	...
	'margin'  => isset( $attributes['headerBox']['margin'] ) ? cozy_render_TRBL( 'margin', $attributes['headerBox']['padding'] ) : '',
...
$post_image = array(
	...
	'fit'      => isset( $attributes['postOptions']['image']['objectFit'] ) ? esc_attr( sanitize_text_field( $attributes['postOptions']['image']['objectFit'] ) ) : '',
	'position' => isset( $attributes['postOptions']['image']['objectPosition'] ) ? esc_attr( sanitize_text_field( $attributes['postOptions']['image']['objectPosition'] ) ) : '',
	'overlay'  => isset( $attributes['postOptions']['image']['overlay'] ) ? cozy_addons_sanitize_dimension( $attributes['postOptions']['image']['overlay'] ) : '',
);
...
$sale_badge = array(
	...
	'left'           => 'left' === $attributes['saleBadge']['position'] ? esc_attr( $attributes['saleBadge']['left'] ) : '',
	'right'          => 'right' === $attributes['saleBadge']['position'] ? esc_attr( $attributes['saleBadge']['right'] ) : '',
	'font'           => array(
		'size'   => isset( $attributes['saleBadge']['font']['size'] ) ? esc_attr( $attributes['saleBadge']['font']['size'] ) : '',
		'weight' => isset( $attributes['saleBadge']['font']['weight'] ) ? esc_attr( sanitize_text_field( $attributes['saleBadge']['font']['weight'] ) ) : '',
		'family' => isset( $attributes['saleBadge']['font']['family'] ) ? esc_attr( sanitize_text_field( $attributes['saleBadge']['font']['family'] ) ) : '',
	),
...
$icon = array(
	...
	'margin'     => array(
		'top'    => 'top' === $attributes['icon']['align']['vertical'] ? cozy_addons_sanitize_dimension( $attributes['icon']['margin']['top'] ) . 'px' : '',
		'right'  => 'right' === $attributes['icon']['align']['horizontal'] ? cozy_addons_sanitize_dimension( $attributes['icon']['margin']['right'] ) : '',
		'bottom' => 'bottom' === $attributes['icon']['align']['vertical'] ? cozy_addons_sanitize_dimension( $attributes['icon']['margin']['top'] ) . 'px' : '',
		'left'   => 'left' === $attributes['icon']['align']['horizontal'] ? cozy_addons_sanitize_dimension( $attributes['icon']['margin']['left'] ) : '',
	),
	...
	'color'      => array(
		...
		'text_active'   => isset( $attributes['icon']['color']['textActive'] ) ? esc_attr( $attributes['icon']['color']['textActive'] ) : '',
		...
		'bg_active'     => isset( $attributes['icon']['color']['bgActive'] ) ? esc_attr( $attributes['icon']['color']['bgActive'] ) : '',
		'border_hover'  => isset( $attributes['icon']['color']['borderHover'] ) ? esc_attr( $attributes['icon']['color']['borderHover'] ) : '',
		'border_active' => isset( $attributes['icon']['color']['borderActive'] ) ? esc_attr( $attributes['icon']['color']['borderActive'] ) : '',
	),
);

$product_category = array(
	'gap'            => isset( $attributes['productCategory']['gap'] ) ? cozy_addons_sanitize_dimension( $attributes['productCategory']['gap'] ) : '',
	'align'          => isset( $attributes['postOptions']['textAlign'] ) ? esc_attr( sanitize_text_field( $attributes['postOptions']['textAlign'] ) ) : '',
	'padding'        => isset( $attributes['productCategory']['padding'] ) ? cozy_render_TRBL( 'padding', $attributes['productCategory']['padding'] ) : '',
	'margin'         => isset( $attributes['productCategory']['margin'] ) ? cozy_render_TRBL( 'margin', $attributes['productCategory']['margin'] ) : '',
	'border'         => isset( $attributes['productCategory']['border'] ) ? cozy_render_TRBL( 'border', $attributes['productCategory']['border'] ) : '',
	'radius'         => isset( $attributes['productCategory']['radius'] ) ? cozy_addons_sanitize_dimension( $attributes['productCategory']['radius'] ) : '',
	'font'           => array(
		'size'   => isset( $attributes['productCategory']['font']['size'] ) ? cozy_addons_sanitize_dimension( $attributes['productCategory']['font']['size'] ) : '',
		'weight' => isset( $attributes['productCategory']['font']['weight'] ) ? esc_attr( sanitize_text_field( $attributes['productCategory']['font']['weight'] ) ) : '',
		'family' => isset( $attributes['productCategory']['font']['family'] ) ? esc_attr( sanitize_text_field( $attributes['productCategory']['font']['family'] ) ) : '',
	),
	'letter_case'    => isset( $attributes['productCategory']['letterCase'] ) ? esc_attr( sanitize_text_field( $attributes['productCategory']['letterCase'] ) ) : '',
	'decoration'     => isset( $attributes['productCategory']['decoration'] ) ? esc_attr( sanitize_text_field( $attributes['productCategory']['decoration'] ) ) : '',
	'line_height'    => isset( $attributes['productCategory']['lineHeight'] ) ? cozy_addons_sanitize_dimension( $attributes['productCategory']['lineHeight'] ) : '',
	'letter_spacing' => isset( $attributes['productCategory']['letterSpacing'] ) ? cozy_addons_sanitize_dimension( $attributes['productCategory']['letterSpacing'] ) : '',
	'color'          => array(
		'text'         => isset( $attributes['productCategory']['color']['text'] ) ? esc_attr( $attributes['productCategory']['color']['text'] ) : '',
		'text_hover'   => isset( $attributes['productCategory']['color']['textHover'] ) ? esc_attr( $attributes['productCategory']['color']['textHover'] ) : '',
		'bg'           => isset( $attributes['productCategory']['color']['bg'] ) ? esc_attr( $attributes['productCategory']['color']['bg'] ) : '',
		'bg_hover'     => isset( $attributes['productCategory']['color']['bgHover'] ) ? esc_attr( $attributes['productCategory']['color']['bgHover'] ) : '',
		'border_hover' => isset( $attributes['productCategory']['color']['borderHover'] ) ? esc_attr( $attributes['productCategory']['color']['borderHover'] ) : '',
	),
);
...
$post_title = array(
	...
	'color'          => array(
		'text'       => isset( $attributes['postOptions']['title']['color']['text'] ) ? esc_attr( $attributes['postOptions']['title']['color']['text'] ) : '',
		'text_hover' => isset( $attributes['postOptions']['title']['color']['textHover'] ) ? esc_attr( $attributes['postOptions']['title']['color']['textHover'] ) : '',
	),
);

$product_price = array(
	'margin'         => isset( $attributes['productPrice']['margin'] ) ? cozy_render_TRBL( 'margin', $attributes['productPrice']['margin'] ) : '',
	'font'           => array(
		'size'   => isset( $attributes['productPrice']['font']['size'] ) ? cozy_addons_sanitize_dimension( $attributes['productPrice']['font']['size'] ) : '',
	...
	'line_height'    => isset( $attributes['productPrice']['lineHeight'] ) ? cozy_addons_sanitize_dimension( $attributes['productPrice']['lineHeight'] ) : '',
	'letter_spacing' => isset( $attributes['productPrice']['letterSpacing'] ) ? cozy_addons_sanitize_dimension( $attributes['productPrice']['letterSpacing'] ) : '',
	'color'          => array(
...
$product_summary = array(
	'margin'         => isset( $attributes['productSummary']['margin'] ) ? cozy_render_TRBL( 'margin', $attributes['productSummary']['margin'] ) : '',
	'font'           => array(
		'size'   => isset( $attributes['productSummary']['font']['size'] ) ? cozy_addons_sanitize_dimension( $attributes['productSummary']['font']['size'] ) : '',
	...
	'letter_case'    => isset( $attributes['productSummary']['letterCase'] ) ? esc_attr( sanitize_text_field( $attributes['productSummary']['letterCase'] ) ) : '',
	'decoration'     => isset( $attributes['productSummary']['decoration'] ) ? esc_attr( sanitize_text_field( $attributes['productSummary']['decoration'] ) ) : '',
	'line_height'    => isset( $attributes['productSummary']['lineHeight'] ) ? cozy_addons_sanitize_dimension( $attributes['productSummary']['lineHeight'] ) : '',
	'letter_spacing' => isset( $attributes['productSummary']['letterSpacing'] ) ? cozy_addons_sanitize_dimension( $attributes['productSummary']['letterSpacing'] ) : '',
	'color'          => array(
		'text' => isset( $attributes['productSummary']['color']['text'] ) ? esc_attr( $attributes['productSummary']['color']['text'] ) : '',
	),
);
...
$cart_btn = array(
	...
	'line_height'    => isset( $attributes['cartButton']['lineHeight'] ) ? cozy_addons_sanitize_dimension( $attributes['cartButton']['lineHeight'] ) : '',
	'letter_spacing' => isset( $attributes['cartButton']['letterSpacing'] ) ? cozy_addons_sanitize_dimension( $attributes['cartButton']['letterSpacing'] ) : '',
	'color'          => array(
...
$quick_view_modal = array(
	'title'       => array(
		...
		'marginTop'    => isset( $attributes['quickViewModal']['productTitle']['marginTop'] ) ? cozy_addons_sanitize_dimension( $attributes['quickViewModal']['productTitle']['marginTop'] ) : '',
		'marginBottom' => isset( $attributes['quickViewModal']['productTitle']['marginBottom'] ) ? cozy_addons_sanitize_dimension( $attributes['quickViewModal']['productTitle']['marginBottom'] ) : '',
	),
	'categories'  => array(
	...
	'view_button' => array(
		...
		'radius'     => isset( $attributes['quickViewModal']['viewCartButton']['radius'] ) ? cozy_addons_sanitize_dimension( $attributes['quickViewModal']['viewCartButton']['radius'] ) : '',
		'color'      => array(
...
$block_styles = "
body #$block_id.cozy-featured-product.toast-message{
    {$toast_card['padding']}
    {$toast_card['border']}
...
#$block_id .cozy-block-featured-product__sale-badge {
    margin-top: {$sale_badge['margin']['top']}px;
    margin-left: {$sale_badge['left']}px;
    margin-right: {$sale_badge['right']}px;
    {$sale_badge['padding']}
    {$sale_badge['border']}
    border-radius: {$sale_badge['radius']};
    font-size: {$sale_badge['font']['size']};
    font-weight: {$sale_badge['font']['weight']};
    font-family: {$sale_badge['font']['family']};
...
.cozy-block-featured-product__icon-container .is-loading-spinner::after{
	border-color:{$icon['color']['text']} !important;
	border-top-color:{$icon['color']['bg']} !important;
}
...
#$block_id .post__content-wrapper .post__categories {
	gap: {$product_category['gap']};
	{$product_category['margin']}
	font-size: {$product_category['font']['size']};
	font-weight: {$product_category['font']['weight']};
	font-family: {$product_category['font']['family']};
    text-transform: {$product_category['letter_case']};
	line-height: {$product_category['line_height']};
	letter-spacing: {$product_category['letter_spacing']};
    justify-content: {$product_category['align']};
}
#$block_id .post__content-wrapper .post__categories a {
	{$product_category['padding']}
	{$product_category['border']}
	border-radius: {$product_category['radius']};
	text-decoration: {$product_category['decoration']};
	color: {$product_category['color']['text']};
	background-color: {$product_category['color']['bg']};
}
#$block_id .post__content-wrapper .post__categories a:hover {
...
#$block_id .post__content-wrapper .post__title {
	{$post_title['margin']}
...
#$block_id .post__content-wrapper .post__title a {
	text-decoration: {$post_title['decoration']};
	color: {$post_title['color']['text']};
}
#$block_id .post__content-wrapper .post__title:hover a {
	color: {$post_title['color']['text_hover']};
}

#$block_id .post__content-wrapper .post__price {
	{$product_price['margin']}
	font-size: {$product_price['font']['size']};
	font-weight: {$product_price['font']['weight']};
	font-family: {$product_price['font']['family']};
...
#$block_id .post__content-wrapper .post__content {
	{$product_summary['margin']}
	font-size: {$product_summary['font']['size']};
	font-weight: {$product_summary['font']['weight']};
	font-family: {$product_summary['font']['family']};
...
#$block_id .post__content-wrapper .post__cart-button {
	width: {$cart_btn['width']};
    {$cart_btn['padding']}
    {$cart_btn['margin']}
    {$cart_btn['border']}
    border-radius: {$cart_btn['radius']};
    font-size: {$cart_btn['font']['size']};
    font-weight: {$cart_btn['font']['weight']};
    font-family: {$cart_btn['font']['family']};
    text-transform: {$cart_btn['letter_case']};
...
#$block_id .post__content-wrapper .post__cart-button:hover {
...
if ( $attributes['enableOptions']['heading'] || $attributes['enableOptions']['subHeading'] ) {
	...
	if ( $attributes['enableOptions']['heading'] ) {
		$title_tag = isset( $attributes['headingTag'] ) && in_array( $attributes['headingTag'], $allowed_tags, true ) ? esc_attr( $attributes['headingTag'] ) : 'h2';
	...
	function get_cozy_block_featured_product_data( $featured_post_args = array() ) {
		if ( ! empty( $featured_post_args ) ) {
			...
			foreach ( $latest_posts->posts as $post ) {
				...
				$post_data['type']                = $product->get_type();
				$post_data['cart_text']           = $product->add_to_cart_text();
				$post_data['in_stock']            = $product->is_in_stock();
...
if ( ! function_exists( 'render_cozy_block_featured_product_data' ) ) {
	function render_cozy_block_featured_product_data( $attributes, $post_data, &$output ) {
		...
		$output   .= '<li class="' . esc_attr( trim( implode( ' ', array_map( 'sanitize_html_class', array_values( $classes ) ) ) ) ) . '" data-product-id="' . esc_attr( $post_data['ID'] ) . '" >';
		...
		if ( $attributes['enableOptions']['postImage'] && ! empty( $post_data['image_url'] ) ) {
			...
			if ( $attributes['enableOptions']['cart'] || $attributes['enableOptions']['wishlist'] || $attributes['enableOptions']['quickView'] ) {
				...
				if ( $attributes['enableOptions']['wishlist'] ) {
					...
					$output            .= '<div class="' . esc_attr( trim( implode( ' ', array_map( 'sanitize_html_class', array_values( $classes ) ) ) ) ) . '" data-product-id="' . esc_attr( $post_data['ID'] ) . '" data-product-name="' . esc_attr( $post_data['post_title'] ) . '">';
				...
				if ( $attributes['enableOptions']['quickView'] ) {
					$output .= '<div class="cozy-block-featured-product__icon-wrapper quick-view__icon-wrapper" data-product-id="' . esc_attr( $post_data['ID'] ) . '">';
		...
		if ( isset( $attributes['enableOptions']['title'] ) && $attributes['enableOptions']['title'] ) {
				...
				$output       .= '<h3 class="post__title"><a ' . $has_post_link . ' target="' . $open_new_tab . '" rel="noopener">' . esc_html( $post_data['post_title'] ) . '</a></h3>';
		}
		...
		if ( $attributes['enableOptions']['productRating'] && $post_data['review_count'] > 0 ) {
			...
			$output        .= '<div class="post__rating" style="display:inline;background: linear-gradient(90deg, #fcb900 ' . esc_attr( $rating_percent ) . ', rgba(0, 0, 0, 0.2) ' . $rating_percent . ')">';
			$output        .= '★★★★★';
			$output        .= '</div>';
			$output        .= '<span style="display:block;">(' . number_format( floatval( $post_data['rating'] ), 1 ) . ' out of ' . esc_html( $post_data['review_count'] ) . ' ' . _n( 'review', 'reviews', $post_data['review_count'], 'cozy-addons' ) . '.)</span>';
			$output        .= '</div>';
		}
		$output .= '</div>';
		...
		if ( isset( $attributes['enableOptions']['cartButton'] ) && $attributes['enableOptions']['postContent'] ) {
			...
			if ( $use_link ) {
				$output .= '<a href="' . esc_url( $post_data['post_link'] ) . '" class="post__cart-button" data-product-id="' . esc_attr( $post_data['ID'] ) . '">';
				$output .= '<span class="cart-button__label">' . esc_html( $post_data['cart_text'] ) . '</span>';
				$output .= '</a>';
			} else {
				$output .= '<div class="post__cart-button product_type_' . esc_html( $product_type ) . ' " data-product-id="' . esc_attr( $post_data['ID'] ) . '">';
...
if ( isset( $attributes['quickViewModal']['viewCartButton']['font']['family'] ) && ! empty( $attributes['quickViewModal']['viewCartButton']['font']['family'] ) ) {
	$font_families[] = sanitize_text_field( $attributes['quickViewModal']['viewCartButton']['font']['family'] );
}
...
if ( isset( $attributes['saleBadge']['font']['family'] ) && ! empty( $attributes['saleBadge']['font']['family'] ) ) {
	$font_families[] = sanitize_text_field( $attributes['saleBadge']['font']['family'] );
}
if ( isset( $attributes['productCategory']['font']['family'] ) && ! empty( $attributes['productCategory']['font']['family'] ) ) {
	$font_families[] = sanitize_text_field( $attributes['productCategory']['font']['family'] );
}
