...
$list = array(
	'column' => isset( $attributes['column'] ) ? esc_attr( $attributes['column'] ) : '',
	'gap'    => isset( $attributes['columnGap'] ) ? esc_attr( $attributes['columnGap'] ) : '',
);

$col1 = isset( $attributes['column'] ) && $attributes['column'] <= 3 ? esc_attr( $attributes['column'] ) : 3;
$col2 = isset( $attributes['column'] ) && $attributes['column'] <= 2 ? esc_attr( $attributes['column'] ) : 2;
...
$item_styles  = array(
	'shadow'             => array(
		'horizontal' => isset( $attributes['itemStyles']['boxShadow']['horizontal'] ) ? esc_attr( $attributes['itemStyles']['boxShadow']['horizontal'] ) : '',
		'vertical'   => isset( $attributes['itemStyles']['boxShadow']['vertical'] ) ? esc_attr( $attributes['itemStyles']['boxShadow']['vertical'] ) : '',
		'blur'       => isset( $attributes['itemStyles']['boxShadow']['blur'] ) ? esc_attr( $attributes['itemStyles']['boxShadow']['blur'] ) : '',
		'spread'     => isset( $attributes['itemStyles']['boxShadow']['spread'] ) ? esc_attr( $attributes['itemStyles']['boxShadow']['spread'] ) : '',
		'position'   => isset( $attributes['itemStyles']['boxShadow']['position'] ) ? esc_attr( sanitize_text_field( $attributes['itemStyles']['boxShadow']['position'] ) ) : '',
	),
	'bg_color'           => isset( $attributes['itemStyles']['bgColor'] ) ? esc_attr( $attributes['itemStyles']['bgColor'] ) : '',
	'bg_color_hover'     => isset( $attributes['itemStyles']['bgColorHover'] ) ? esc_attr( $attributes['itemStyles']['bgColorHover'] ) : '',
	'border_color_hover' => isset( $attributes['itemStyles']['borderColorHover'] ) ? esc_attr( $attributes['itemStyles']['borderColorHover'] ) : '',
	'shadow_color'       => isset( $attributes['itemStyles']['boxShadow']['color'] ) ? esc_attr( $attributes['itemStyles']['boxShadow']['color'] ) : '',
);
...
$cat_styles  = array(
	...
	'radius'             => isset( $attributes['categoryStyles']['radius'] ) ? esc_attr( $attributes['categoryStyles']['radius'] ) : '',
	'font'               => array(
		'size'   => isset( $attributes['categoryStyles']['fontSize'] ) ? esc_attr( $attributes['categoryStyles']['fontSize'] ) : '',
	...
	'line_height'        => isset( $attributes['categoryStyles']['lineHeight'] ) ? esc_attr( $attributes['categoryStyles']['lineHeight'] ) : '',
	'letter_spacing'     => isset( $attributes['categoryStyles']['letterSpacing'] ) ? esc_attr( $attributes['categoryStyles']['letterSpacing'] ) : '',
...
$title_styles = array(
	'margin'         => array(
		'top'    => isset( $attributes['titleStyles']['marginTop'] ) ? esc_attr( $attributes['titleStyles']['marginTop'] ) : '',
		'bottom' => isset( $attributes['titleStyles']['marginBottom'] ) ? esc_attr( $attributes['titleStyles']['marginBottom'] ) : '',
	),
	'font'           => array(
		'size'   => isset( $attributes['titleStyles']['fontSize'] ) ? esc_attr( $attributes['titleStyles']['fontSize'] ) : '',
	...
	'line_height'    => isset( $attributes['titleStyles']['lineHeight'] ) ? esc_attr( $attributes['titleStyles']['lineHeight'] ) : '',
	'letter_spacing' => isset( $attributes['titleStyles']['letterSpacing'] ) ? esc_attr( $attributes['titleStyles']['letterSpacing'] ) : '',
...
$meta_styles  = array(
	'radius'             => isset( $attributes['dateStyles']['radius'] ) ? esc_attr( $attributes['dateStyles']['radius'] ) : '',
	'font'               => array(
		'size'   => isset( $attributes['dateStyles']['fontSize'] ) ? esc_attr( $attributes['dateStyles']['fontSize'] ) : '',
	...
	'line_height'        => isset( $attributes['dateStyles']['lineHeight'] ) ? esc_attr( $attributes['dateStyles']['lineHeight'] ) : '',
	'letter_spacing'     => isset( $attributes['dateStyles']['letterSpacing'] ) ? esc_attr( $attributes['dateStyles']['letterSpacing'] ) : '',
...
$loader = array(
	'label'          => isset( $attributes['ajaxLoader']['label'] ) ? sanitize_text_field( $attributes['ajaxLoader']['label'] ) : '',
	'loading_text'   => isset( $attributes['ajaxLoader']['loadingText'] ) ? sanitize_text_field( $attributes['ajaxLoader']['loadingText'] ) : '',
	'min_width'      => isset( $attributes['ajaxLoader']['minWidth'] ) ? esc_attr( $attributes['ajaxLoader']['minWidth'] ) : '',
	...
	'font'           => array(
		'size'   => isset( $attributes['ajaxLoader']['font']['size'] ) ? esc_attr( $attributes['ajaxLoader']['font']['size'] ) : '',
	...
	'line_height'    => isset( $attributes['ajaxLoader']['lineHeight'] ) ? esc_attr( $attributes['ajaxLoader']['lineHeight'] ) : '',
	'letter_spacing' => isset( $attributes['ajaxLoader']['letterSpacing'] ) ? esc_attr( $attributes['ajaxLoader']['letterSpacing'] ) : '',
	'text_align'     => isset( $attributes['ajaxLoader']['textAlign'] ) ? esc_attr( sanitize_text_field( $attributes['ajaxLoader']['textAlign'] ) ) : '',
	'color'          => array(
		'text'              => isset( $attributes['ajaxLoader']['color']['text'] ) ? esc_attr( sanitize_text_field( $attributes['ajaxLoader']['color']['text'] ) ) : '',
		'text_hover'        => isset( $attributes['ajaxLoader']['color']['textHover'] ) ? esc_attr( sanitize_text_field( $attributes['ajaxLoader']['color']['textHover'] ) ) : '',
		'spinner_primary'   => isset( $attributes['ajaxLoader']['color']['spinnerPrimary'] ) ? esc_attr( sanitize_text_field( $attributes['ajaxLoader']['color']['spinnerPrimary'] ) ) : '',
		'spinner_secondary' => isset( $attributes['ajaxLoader']['color']['spinnerSecondary'] ) ? esc_attr( sanitize_text_field( $attributes['ajaxLoader']['color']['spinnerSecondary'] ) ) : '',
		'bg'                => isset( $attributes['ajaxLoader']['color']['bg'] ) ? esc_attr( sanitize_text_field( $attributes['ajaxLoader']['color']['bg'] ) ) : '',
		'bg_hover'          => isset( $attributes['ajaxLoader']['color']['bgHover'] ) ? esc_attr( sanitize_text_field( $attributes['ajaxLoader']['color']['bgHover'] ) ) : '',
		'border_hover'      => isset( $attributes['ajaxLoader']['color']['borderHover'] ) ? esc_attr( sanitize_text_field( $attributes['ajaxLoader']['color']['borderHover'] ) ) : '',
	),
);
...
$nav        = array(
	...
	'right'              => isset( $attributes['navigation']['horizontalGap'] ) ? esc_attr( $attributes['navigation']['horizontalGap'] ) : '',
...
$bullets = array(
	'width'  => isset( $attributes['pagination']['width'] ) ? esc_attr( $attributes['pagination']['width'] ) : '10px',
	'height' => isset( $attributes['pagination']['height'] ) ? esc_attr( $attributes['pagination']['height'] ) : '10px',
	'radius' => isset( $attributes['pagination']['radius'] ) ? esc_attr( $attributes['pagination']['radius'] ) : '10px',
	'gap'    => isset( $attributes['pagination']['gap'] ) ? esc_attr( $attributes['pagination']['gap'] ) : '4px',
	'active' => array(
		'width'   => isset( $attributes['pagination']['active']['width'] ) ? esc_attr( $attributes['pagination']['active']['width'] ) : '10px',
		'height'  => isset( $attributes['pagination']['active']['height'] ) ? esc_attr( $attributes['pagination']['active']['height'] ) : '10px',
		'radius'  => isset( $attributes['pagination']['active']['radius'] ) ? esc_attr( $attributes['pagination']['active']['radius'] ) : '10px',
	...
	'top'    => isset( $attributes['pagination']['top'] ) ? esc_attr( $attributes['pagination']['top'] ) : '',
...
#$block_id .post__meta a {
	...
	letter-spacing: {$meta_styles['letter_spacing']};
	color: {$meta_styles['color']};
	background-color: {$meta_styles['bg_color']};
}
#$block_id .post__meta svg {
	fill: {$meta_styles['color']};
}
#$block_id .post__meta a:hover {
	color: {$meta_styles['color_hover']};
	background-color: {$meta_styles['bg_color_hover']};
	border-color: {$meta_styles['border_color_hover']};
}
#$block_id .post__meta a:hover svg {
	fill: {$meta_styles['color_hover']};
}
...
#$block_id .swiper-button-prev {
    right: var(--swiper-navigation-sides-offset, {$nav['right']});
}
...
foreach ( $additional_post_data as $post_data ) {
	...
	$output        .= '<li class="' . esc_attr( cozy_addons_sanitize_html_class( $item_classes ) ) . '" data-post-id="' . esc_attr( $post_data['ID'] ) . '">';
	...
	if ( $attributes['enableOptions']['image'] && ! empty( $post_data['post_image_url'] ) ) {
		...
		$output          .= '<figure class="' . esc_attr( cozy_addons_sanitize_html_class( $figure_classes ) ) . '">';
	...
	if ( $attributes['enableOptions']['category'] ) {
		...
		$output            .= '<div class="' . esc_attr( cozy_addons_sanitize_html_class( $category_classes ) ) . '">';
	...
	$output .= '<h3 class="' . esc_attr( cozy_addons_sanitize_html_class( $classes ) ) . '"><a ' . $has_post_link . ' target="' . $open_new_tab . '" rel="noopener">' . esc_html( $post_data['post_title'] ) . '</a></h3>';
...
if ( isset( $attributes['ajaxLoader']['enabled'] ) && $attributes['ajaxLoader']['enabled'] && ( 'grid' === $attributes['display'] || 'list' === $attributes['display'] ) ) {
	if ( isset( $attributes['ajaxLoader']['type'] ) && 'default' === $attributes['ajaxLoader']['type'] ) {
		...
		$output   .= '<button class="' . esc_attr( cozy_addons_sanitize_html_class( $classes ) ) . '">';
...
if ( isset( $attributes['categoryStyles']['fontFamily'] ) && ! empty( $attributes['categoryStyles']['fontFamily'] ) ) {
	$font_families[] = sanitize_html_class( $attributes['categoryStyles']['fontFamily'] );
}
if ( isset( $attributes['titleStyles']['fontFamily'] ) && ! empty( $attributes['titleStyles']['fontFamily'] ) ) {
	$font_families[] = sanitize_html_class( $attributes['titleStyles']['fontFamily'] );
}
if ( isset( $attributes['dateStyles']['fontFamily'] ) && ! empty( $attributes['dateStyles']['fontFamily'] ) ) {
	$font_families[] = sanitize_html_class( $attributes['dateStyles']['fontFamily'] );
}
if ( isset( $attributes['ajaxLoader']['font']['family'] ) && ! empty( $attributes['ajaxLoader']['font']['family'] ) ) {
	$font_families[] = sanitize_html_class( $attributes['ajaxLoader']['font']['family'] );
}
