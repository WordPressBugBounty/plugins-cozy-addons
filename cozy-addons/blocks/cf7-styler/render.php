...
$styles = array(
	'gap'     => isset( $attributes['gap'] ) ? cozy_addons_sanitize_dimension( $attributes['gap'] ) : '',
	...
	'shadow'  => array(
		'horizontal' => isset( $attributes['shadow']['horizontal'] ) ? cozy_addons_sanitize_dimension( $attributes['shadow']['horizontal'] ) : '',
		'vertical'   => isset( $attributes['shadow']['vertical'] ) ? cozy_addons_sanitize_dimension( $attributes['shadow']['vertical'] ) : '',
		'blur'       => isset( $attributes['shadow']['blur'] ) ? cozy_addons_sanitize_dimension( $attributes['shadow']['blur'] ) : '',
		'spread'     => isset( $attributes['shadow']['spread'] ) ? cozy_addons_sanitize_dimension( $attributes['shadow']['spread'] ) : '',
	...
	'font'    => array(
		'size'   => isset( $attributes['font']['size'] ) ? cozy_addons_sanitize_dimension( $attributes['font']['size'] ) : '',
...
$text_styles = array(
	...
	'font'            => array(
		'size'   => isset( $attributes['textStyles']['font']['size'] ) ? cozy_addons_sanitize_dimension( $attributes['textStyles']['font']['size'] ) : '',
		'weight' => isset( $attributes['textStyles']['font']['weight'] ) ? esc_attr( sanitize_text_field( $attributes['textStyles']['font']['weight'] ) ) : '',
		'family' => isset( $attributes['textStyles']['font']['family'] ) ? esc_attr( sanitize_text_field( $attributes['textStyles']['font']['family'] ) ) : '',
	),
	'letter_case'     => isset( $attributes['textStyles']['letterCase'] ) ? esc_attr( sanitize_text_field( $attributes['textStyles']['letterCase'] ) ) : '',
	'decoration'      => isset( $attributes['textStyles']['decoration'] ) ? esc_attr( sanitize_text_field( $attributes['textStyles']['decoration'] ) ) : '',
	'line_height'     => isset( $attributes['textStyles']['lineHeight'] ) ? cozy_addons_sanitize_dimension( $attributes['textStyles']['lineHeight'] ) : '',
	'letter_spacing'  => isset( $attributes['textStyles']['letterSpacing'] ) ? cozy_addons_sanitize_dimension( $attributes['textStyles']['letterSpacing'] ) : '',
	'color'           => array(
		'text'       => isset( $attributes['textStyles']['color']['text'] ) ? esc_attr( $attributes['textStyles']['color']['text'] ) : '',
		'text_focus' => isset( $attributes['textStyles']['color']['textFocus'] ) ? esc_attr( $attributes['textStyles']['color']['textFocus'] ) : '',
		'bg'         => isset( $attributes['textStyles']['color']['bg'] ) ? esc_attr( $attributes['textStyles']['color']['bg'] ) : '',
		'bg_focus'   => isset( $attributes['textStyles']['color']['bgFocus'] ) ? esc_attr( $attributes['textStyles']['color']['bgFocus'] ) : '',
	),
);

$date_styles = array(
	'padding'        => isset( $attributes['dateStyles']['padding'] ) ? cozy_render_TRBL( 'padding', $attributes['dateStyles']['padding'] ) : '',
	'margin'         => isset( $attributes['dateStyles']['margin'] ) ? cozy_render_TRBL( 'margin', $attributes['dateStyles']['margin'] ) : '',
	...
	'font'           => array(
		'size'   => isset( $attributes['dateStyles']['font']['size'] ) ? cozy_addons_sanitize_dimension( $attributes['dateStyles']['font']['size'] ) : '',
		'weight' => isset( $attributes['dateStyles']['font']['weight'] ) ? esc_attr( sanitize_text_field( $attributes['dateStyles']['font']['weight'] ) ) : '',
		'family' => isset( $attributes['dateStyles']['font']['family'] ) ? esc_attr( sanitize_text_field( $attributes['dateStyles']['font']['family'] ) ) : '',
	),
	...
	'letter_spacing' => isset( $attributes['dateStyles']['letterSpacing'] ) ? cozy_addons_sanitize_dimension( $attributes['dateStyles']['letterSpacing'] ) : '',
	'color'          => array(
		'text' => isset( $attributes['dateStyles']['color']['text'] ) ? esc_attr( $attributes['dateStyles']['color']['text'] ) : '',
		'bg'   => isset( $attributes['dateStyles']['color']['bg'] ) ? esc_attr( $attributes['dateStyles']['color']['bg'] ) : '',
	),
);

$dropdown_styles = array(
	'width'          => isset( $attributes['dropdownStyles']['width'] ) ? cozy_addons_sanitize_dimension( $attributes['dropdownStyles']['width'] ) : '',
	...
	'radius'         => isset( $attributes['dropdownStyles']['radius'] ) ? cozy_addons_sanitize_dimension( $attributes['dropdownStyles']['radius'] ) : '',
	'font'           => array(
		'size'   => isset( $attributes['dropdownStyles']['font']['size'] ) ? cozy_addons_sanitize_dimension( $attributes['dropdownStyles']['font']['size'] ) : '',
		'weight' => isset( $attributes['dropdownStyles']['font']['weight'] ) ? esc_attr( sanitize_text_field( $attributes['dropdownStyles']['font']['weight'] ) ) : '',
		'family' => isset( $attributes['dropdownStyles']['font']['family'] ) ? esc_attr( sanitize_text_field( $attributes['dropdownStyles']['font']['family'] ) ) : '',
	),
	'letter_case'    => isset( $attributes['dropdownStyles']['letterCase'] ) ? esc_attr( sanitize_text_field( $attributes['dropdownStyles']['letterCase'] ) ) : '',
	'decoration'     => isset( $attributes['dropdownStyles']['decoration'] ) ? esc_attr( sanitize_text_field( $attributes['dropdownStyles']['decoration'] ) ) : '',
	'line_height'    => isset( $attributes['dropdownStyles']['lineHeight'] ) ? cozy_addons_sanitize_dimension( $attributes['dropdownStyles']['lineHeight'] ) : '',
	'letter_spacing' => isset( $attributes['dropdownStyles']['letterSpacing'] ) ? cozy_addons_sanitize_dimension( $attributes['dropdownStyles']['letterSpacing'] ) : '',
	'color'          => array(
		'text' => isset( $attributes['dropdownStyles']['color']['text'] ) ? esc_attr( $attributes['dropdownStyles']['color']['text'] ) : '',
		'bg'   => isset( $attributes['dropdownStyles']['color']['bg'] ) ? esc_attr( $attributes['dropdownStyles']['color']['bg'] ) : '',
	),
);

$chkbx_styles = array(
	'padding'        => isset( $attributes['checkboxStyles']['padding'] ) ? cozy_render_TRBL( 'padding', $attributes['checkboxStyles']['padding'] ) : '',
	'item_gap'       => isset( $attributes['checkboxStyles']['itemGap'] ) ? cozy_addons_sanitize_dimension( $attributes['checkboxStyles']['itemGap'] ) : '',
	'size'           => isset( $attributes['checkboxStyles']['size'] ) ? cozy_addons_sanitize_dimension( $attributes['checkboxStyles']['size'] ) : '',
	'font'           => array(
		'size'   => isset( $attributes['checkboxStyles']['font']['size'] ) ? cozy_addons_sanitize_dimension( $attributes['checkboxStyles']['font']['size'] ) : '',
		'weight' => isset( $attributes['checkboxStyles']['font']['weight'] ) ? esc_attr( sanitize_text_field( $attributes['checkboxStyles']['font']['weight'] ) ) : '',
		'family' => isset( $attributes['checkboxStyles']['font']['family'] ) ? esc_attr( sanitize_text_field( $attributes['checkboxStyles']['font']['family'] ) ) : '',
	),
	'letter_case'    => isset( $attributes['checkboxStyles']['letterCase'] ) ? esc_attr( sanitize_text_field( $attributes['checkboxStyles']['letterCase'] ) ) : '',
	'decoration'     => isset( $attributes['checkboxStyles']['decoration'] ) ? esc_attr( sanitize_text_field( $attributes['checkboxStyles']['decoration'] ) ) : '',
	'line_height'    => isset( $attributes['checkboxStyles']['lineHeight'] ) ? cozy_addons_sanitize_dimension( $attributes['checkboxStyles']['lineHeight'] ) : '',
	'letter_spacing' => isset( $attributes['checkboxStyles']['letterSpacing'] ) ? cozy_addons_sanitize_dimension( $attributes['checkboxStyles']['letterSpacing'] ) : '',
	'color'          => array(
		'text' => isset( $attributes['checkboxStyles']['color']['text'] ) ? esc_attr( $attributes['checkboxStyles']['color']['text'] ) : '',
	),
);

$radio_styles = array(
	'padding'        => isset( $attributes['radioStyles']['padding'] ) ? cozy_render_TRBL( 'padding', $attributes['radioStyles']['padding'] ) : '',
	'item_gap'       => isset( $attributes['radioStyles']['itemGap'] ) ? cozy_addons_sanitize_dimension( $attributes['radioStyles']['itemGap'] ) : '',
	'size'           => isset( $attributes['radioStyles']['size'] ) ? cozy_addons_sanitize_dimension( $attributes['radioStyles']['size'] ) : '',
	'font'           => array(
		'size'   => isset( $attributes['radioStyles']['font']['size'] ) ? cozy_addons_sanitize_dimension( $attributes['radioStyles']['font']['size'] ) : '',
		'weight' => isset( $attributes['radioStyles']['font']['weight'] ) ? esc_attr( sanitize_text_field( $attributes['radioStyles']['font']['weight'] ) ) : '',
		'family' => isset( $attributes['radioStyles']['font']['family'] ) ? esc_attr( sanitize_text_field( $attributes['radioStyles']['font']['family'] ) ) : '',
	),
	'letter_case'    => isset( $attributes['radioStyles']['letterCase'] ) ? esc_attr( sanitize_text_field( $attributes['radioStyles']['letterCase'] ) ) : '',
	'decoration'     => isset( $attributes['radioStyles']['decoration'] ) ? esc_attr( sanitize_text_field( $attributes['radioStyles']['decoration'] ) ) : '',
	'line_height'    => isset( $attributes['radioStyles']['lineHeight'] ) ? cozy_addons_sanitize_dimension( $attributes['radioStyles']['lineHeight'] ) : '',
	'letter_spacing' => isset( $attributes['radioStyles']['letterSpacing'] ) ? cozy_addons_sanitize_dimension( $attributes['radioStyles']['letterSpacing'] ) : '',
	'color'          => array(
		'text' => isset( $attributes['radioStyles']['color']['text'] ) ? esc_attr( $attributes['radioStyles']['color']['text'] ) : '',
	),
);
...
$acceptance_styles = array(
	...
	'size'           => isset( $attributes['acceptanceStyles']['size'] ) ? cozy_addons_sanitize_dimension( $attributes['acceptanceStyles']['size'] ) : '',
	'font'           => array(
		'size'   => isset( $attributes['acceptanceStyles']['font']['size'] ) ? cozy_addons_sanitize_dimension( $attributes['acceptanceStyles']['font']['size'] ) : '',
		'weight' => isset( $attributes['acceptanceStyles']['font']['weight'] ) ? esc_attr( sanitize_text_field( $attributes['acceptanceStyles']['font']['weight'] ) ) : '',
		'family' => isset( $attributes['acceptanceStyles']['font']['family'] ) ? esc_attr( sanitize_text_field( $attributes['acceptanceStyles']['font']['family'] ) ) : '',
	),
	'letter_case'    => isset( $attributes['acceptanceStyles']['letterCase'] ) ? esc_attr( sanitize_text_field( $attributes['acceptanceStyles']['letterCase'] ) ) : '',
	'decoration'     => isset( $attributes['acceptanceStyles']['decoration'] ) ? esc_attr( sanitize_text_field( $attributes['acceptanceStyles']['decoration'] ) ) : '',
	'line_height'    => isset( $attributes['acceptanceStyles']['lineHeight'] ) ? cozy_addons_sanitize_dimension( $attributes['acceptanceStyles']['lineHeight'] ) : '',
	'letter_spacing' => isset( $attributes['acceptanceStyles']['letterSpacing'] ) ? cozy_addons_sanitize_dimension( $attributes['acceptanceStyles']['letterSpacing'] ) : '',
	'color'          => array(
		'text' => isset( $attributes['acceptanceStyles']['color']['text'] ) ? esc_attr( $attributes['acceptanceStyles']['color']['text'] ) : '',
	),
);
...
$file_styles = array(
	...
	'radius'  => isset( $attributes['fileStyles']['radius'] ) ? cozy_addons_sanitize_dimension( $attributes['fileStyles']['radius'] ) : '',
	'color'   => array(
		'text'         => isset( $attributes['fileStyles']['color']['text'] ) ? esc_attr( $attributes['fileStyles']['color']['text'] ) : '',
		'text_hover'   => isset( $attributes['fileStyles']['color']['textHover'] ) ? esc_attr( $attributes['fileStyles']['color']['textHover'] ) : '',
		'bg'           => isset( $attributes['fileStyles']['color']['bg'] ) ? esc_attr( $attributes['fileStyles']['color']['bg'] ) : '',
		'bg_hover'     => isset( $attributes['fileStyles']['color']['bgHover'] ) ? esc_attr( $attributes['fileStyles']['color']['bgHover'] ) : '',
		'border_hover' => isset( $attributes['fileStyles']['color']['borderHover'] ) ? esc_attr( $attributes['fileStyles']['color']['borderHover'] ) : '',
	),
);

$btn_styles = array(
	'display'        => isset( $attributes['buttonStyles']['display'] ) ? esc_attr( sanitize_text_field( $attributes['buttonStyles']['display'] ) ) : '',
	'width'          => isset( $attributes['buttonStyles']['width'] ) ? cozy_addons_sanitize_dimension( $attributes['buttonStyles']['width'] ) : '',
	'padding'        => isset( $attributes['buttonStyles']['padding'] ) ? cozy_render_TRBL( 'padding', $attributes['buttonStyles']['padding'] ) : '',
	'margin'         => array(
		'top'    => isset( $attributes['buttonStyles']['margin']['top'] ) ? cozy_addons_sanitize_dimension( $attributes['buttonStyles']['margin']['top'] ) : '',
		'right'  => 'center' === $attributes['buttonStyles']['align'] ? 'auto' : '',
		'bottom' => isset( $attributes['buttonStyles']['margin']['bottom'] ) ? cozy_addons_sanitize_dimension( $attributes['buttonStyles']['margin']['bottom'] ) : '',
	...
	'font'           => array(
		'size'   => isset( $attributes['buttonStyles']['font']['size'] ) ? cozy_addons_sanitize_dimension( $attributes['buttonStyles']['font']['size'] ) : '',
		'weight' => isset( $attributes['buttonStyles']['font']['weight'] ) ? esc_attr( sanitize_text_field( $attributes['buttonStyles']['font']['weight'] ) ) : '',
		'family' => isset( $attributes['buttonStyles']['font']['family'] ) ? esc_attr( sanitize_text_field( $attributes['buttonStyles']['font']['family'] ) ) : '',
	),
	'letter_case'    => isset( $attributes['buttonStyles']['letterCase'] ) ? esc_attr( sanitize_text_field( $attributes['buttonStyles']['letterCase'] ) ) : '',
	'decoration'     => isset( $attributes['buttonStyles']['decoration'] ) ? esc_attr( sanitize_text_field( $attributes['buttonStyles']['decoration'] ) ) : '',
	'line_height'    => isset( $attributes['buttonStyles']['lineHeight'] ) ? cozy_addons_sanitize_dimension( $attributes['buttonStyles']['lineHeight'] ) : '',
	'letter_spacing' => isset( $attributes['buttonStyles']['letterSpacing'] ) ? cozy_addons_sanitize_dimension( $attributes['buttonStyles']['letterSpacing'] ) : '',
	'color'          => array(
		'text'         => isset( $attributes['buttonStyles']['color']['text'] ) ? esc_attr( $attributes['buttonStyles']['color']['text'] ) : '',
		'text_hover'   => isset( $attributes['buttonStyles']['color']['textHover'] ) ? esc_attr( $attributes['buttonStyles']['color']['textHover'] ) : '',
		'bg'           => isset( $attributes['buttonStyles']['color']['bg'] ) ? esc_attr( $attributes['buttonStyles']['color']['bg'] ) : '',
		'bg_hover'     => isset( $attributes['buttonStyles']['color']['bgHover'] ) ? esc_attr( $attributes['buttonStyles']['color']['bgHover'] ) : '',
		'border_hover' => isset( $attributes['buttonStyles']['color']['borderHover'] ) ? esc_attr( $attributes['buttonStyles']['color']['borderHover'] ) : '',
	),
);
