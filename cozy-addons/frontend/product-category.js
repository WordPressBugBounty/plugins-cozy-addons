(function ($) {
	window["cozyBlockProductCategoryInit"] = (e) => {
		...
		const sliderAttr = {
			...
			navigation: {
				nextEl: `.cozy-block-product-category-wrapper.block-wrapper-${blockOptions.blockClientId} .swiper-button-next`,
				prevEl: `.cozy-block-product-category-wrapper.block-wrapper-${blockOptions.blockClientId} .swiper-button-prev`,
			},
			pagination: {
				clickable: true,
				el: `.cozy-block-product-category-wrapper.block-wrapper-${blockOptions.blockClientId} .swiper-pagination`,
			},
			breakpoints: {
				100: {
					slidesPerView: 1,
