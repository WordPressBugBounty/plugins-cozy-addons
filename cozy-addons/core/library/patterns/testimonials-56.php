...
?>
<!-- wp:group {"style":{"color":{"text":"#4b504f","background":"#f0f3f3"},"elements":{"link":{"color":{"text":"#4b504f"}}},"typography":{"lineHeight":1.6,"fontStyle":"normal","fontWeight":"400","fontSize":"16px"},"spacing":{"padding":{"right":"0px","left":"26px","top":"80px","bottom":"80px"},"margin":{"top":"0","bottom":"0"}}},"layout":{"type":"constrained","contentSize":"100%"},"cozyCustomFont":"Inter"} -->
<div class="wp-block-group has-text-color has-background has-link-color" style="color:#4b504f;background-color:#f0f3f3;margin-top:0;margin-bottom:0;padding-top:80px;padding-right:0px;padding-bottom:80px;padding-left:26px;font-size:16px;font-style:normal;font-weight:400;line-height:1.6"><!-- wp:group {"style":{"spacing":{"blockGap":"0","margin":{"top":"0","bottom":"44px"},"padding":{"right":"26px","left":"0px"}}},"layout":{"type":"constrained","contentSize":"1180px"}} -->
<div class="wp-block-group" style="margin-top:0;margin-bottom:44px;padding-right:26px;padding-left:0px"><!-- wp:columns {"verticalAlignment":null,"style":{"spacing":{"margin":{"top":"0","bottom":"44px"},"blockGap":{"top":"26px","left":"26px"},"padding":{"right":"26px","left":"26px","top":"26px","bottom":"26px"}},"color":{"background":"#f0f3f3"},"border":{"radius":{"topLeft":"16px","topRight":"16px","bottomLeft":"16px","bottomRight":"16px"}}}} -->
<div class="wp-block-columns has-background" style="border-top-left-radius:16px;border-top-right-radius:16px;border-bottom-left-radius:16px;border-bottom-right-radius:16px;background-color:#f0f3f3;margin-top:0;margin-bottom:44px;padding-top:26px;padding-right:26px;padding-bottom:26px;padding-left:26px"><!-- wp:column {"verticalAlignment":"center","width":"60%","style":{"spacing":{"blockGap":"0"}},"layout":{"type":"default"}} -->
<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:60%"><!-- wp:group {"style":{"spacing":{"blockGap":"5px","margin":{"bottom":"16px"}}},"layout":{"type":"flex","flexWrap":"nowrap","justifyContent":"left"}} -->
...
<h2 class="wp-block-heading has-text-color has-link-color" style="color:#03201b;font-size:64px;font-style:normal;font-weight:500;letter-spacing:-2px;line-height:1.2"><?php esc_html_e( 'Globally recognized for building brands that grow', 'cozy-addons' ); ?></h2>
<!-- /wp:heading --></div>
<!-- /wp:column -->

<!-- wp:column {"style":{"spacing":{"blockGap":"0"}}} -->
<div class="wp-block-column"><!-- wp:paragraph {"style":{"spacing":{"padding":{"top":"12px","bottom":"26px"}}}} -->
<p style="padding-top:12px;padding-bottom:26px"><?php esc_html_e( 'Launch faster, showcase smarter, and convert better with this bold modern template', 'cozy-addons' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group -->
...
<div class="wp-block-group"><!-- wp:image {"width":"64px","height":"64px","scale":"cover","sizeSlug":"large","style":{"border":{"radius":{"topLeft":"100px","topRight":"100px","bottomLeft":"100px","bottomRight":"100px"}}}} -->
