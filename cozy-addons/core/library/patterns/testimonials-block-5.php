...
<h3 class="wp-block-heading has-text-align-center" style="margin-top:8px;margin-bottom:2px;font-size:18px;font-style:normal;font-weight:500;line-height:1.3">Jesisica Nguyen</h3>
<!-- /wp:heading -->
...
<p class="has-text-align-center has-text-color has-link-color" style="color:#5c5c5e;margin-top:2px;margin-bottom:0;font-size:13px">Graphics Designer</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<h4 class="wp-block-heading has-text-align-center" style="margin-top:16px;margin-bottom:16px;font-size:16px;font-style:normal;font-weight:600;line-height:1.3">The Best WordPress Templates</h4>
<!-- /wp:heading -->

<!-- wp:paragraph {"style":{"typography":{"textAlign":"center"}}} -->
<p class="has-text-align-center">I’ve used other kits, but this one is the best. The attention to detail and usability are truly amazing.</p>
<!-- /wp:paragraph -->
...
<p class="has-text-color has-link-color" style="color:#5c5c5e;margin-top:0px;margin-bottom:0;font-size:13px">Verified Google Review</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:cozy-block/grid -->
