...
<div class="wp-block-column"><!-- wp:group {"style":{"spacing":{"blockGap":"8px"},"typography":{"fontSize":"12px"}},"layout":{"type":"flex","flexWrap":"nowrap"}} -->
<div class="wp-block-group" style="font-size:12px"><!-- wp:post-terms {"term":"category","separator":"","style":{"spacing":{"padding":{"right":"8px"}},"border":{"top":{"width":"0px","style":"none"},"right":{"color":"#0000001a","width":"1px"},"bottom":{"width":"0px","style":"none"},"left":{"width":"0px","style":"none"}},"typography":{"fontSize":"12px"}},"cozyItemStyles":{"padding":{"top":"6px","right":"10px","bottom":"6px","left":"10px"},"border":{"width":"","style":"","color":""},"radius":"4px","primaryColor":{"text":"#FFFFFF","bg":"#0052ff","textHover":"","bgHover":""},"secondaryColor":{"text":"currentColor","bg":"#2DC7BF","textHover":"","bgHover":""},"gap":"4px","alternateColor":false}} /-->

<!-- wp:post-date {"datetime":"2026-06-29T12:51:23.388Z","style":{"typography":{"fontSize":"12px"}}} /--></div>
<!-- /wp:group -->
...
<!-- wp:post-excerpt {"excerptLength":18,"style":{"spacing":{"margin":{"top":"16px"}},"typography":{"fontSize":"16px"}}} /--></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->
<!-- /wp:post-template -->
...
<div class="wp-block-query"><!-- wp:post-template -->
<!-- wp:group {"style":{"typography":{"fontSize":"12px"}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group" style="font-size:12px"><!-- wp:post-featured-image {"isLink":true,"width":"100%","height":"380px","style":{"border":{"radius":{"topLeft":"8px","topRight":"8px","bottomLeft":"8px","bottomRight":"8px"}}}} /-->

<!-- wp:post-terms {"term":"category","separator":"","style":{"typography":{"textAlign":"center","fontSize":"12px"}},"cozyItemStyles":{"padding":{"top":"6px","right":"10px","bottom":"6px","left":"10px"},"border":{"width":"","style":"","color":""},"radius":"4px","primaryColor":{"text":"#FFFFFF","bg":"#0052ff","textHover":"","bgHover":""},"secondaryColor":{"text":"currentColor","bg":"#2DC7BF","textHover":"","bgHover":""},"gap":"4px","alternateColor":false}} /-->
...
<!-- wp:post-excerpt {"textAlign":"center","excerptLength":28,"style":{"spacing":{"margin":{"top":"24px"}},"typography":{"fontSize":"16px"}}} /--></div>
<!-- /wp:group -->
<!-- /wp:post-template -->
