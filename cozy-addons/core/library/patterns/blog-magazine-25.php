...
<p class="has-foreground-color has-text-color has-link-color"><a href="#"><?php esc_html_e( 'View All', 'cozy-addons' ); ?></a></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<!-- wp:post-title {"textAlign":"left","level":3,"isLink":true,"style":{"elements":{"link":{"color":{"text":"#101112"}}},"spacing":{"margin":{"top":"16px"}},"border":{"radius":{"topLeft":"8px","topRight":"8px","bottomLeft":"8px","bottomRight":"8px"}},"typography":{"fontSize":"24px"},"color":{"text":"#101112"}}} /-->
...
<!-- wp:post-title {"level":3,"isLink":true,"style":{"elements":{"link":{"color":{"text":"#101112"}}},"color":{"text":"#101112"},"typography":{"fontSize":"16px"}}} /-->
