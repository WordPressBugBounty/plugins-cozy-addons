...
<!-- wp:post-title {"textAlign":"left","level":3,"isLink":true,"style":{"elements":{"link":{"color":{"text":"var:preset|color|background"}}},"spacing":{"margin":{"top":"16px"}},"border":{"radius":{"topLeft":"8px","topRight":"8px","bottomLeft":"8px","bottomRight":"8px"}}},"textColor":"background","fontSize":"xx-large"} /-->
...
<!-- wp:columns {"verticalAlignment":null,"style":{"spacing":{"blockGap":{"top":"12px","left":"12px"},"padding":{"bottom":"0"},"margin":{"top":"0","bottom":"0"}}}} -->
...
<!-- wp:post-title {"level":3,"isLink":true,"style":{"elements":{"link":{"color":{"text":"var:preset|color|dark-color"},":hover":{"color":{"text":"var:preset|color|primary"}}}},"spacing":{"margin":{"top":"16px"}},"typography":{"lineHeight":"1.3"}},"textColor":"dark-color","fontSize":"medium"} /-->
