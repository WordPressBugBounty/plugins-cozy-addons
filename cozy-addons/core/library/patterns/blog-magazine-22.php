...
<!-- wp:post-title {"level":3,"isLink":true,"style":{"elements":{"link":{"color":{"text":"var:preset|color|dark-color"}}},"spacing":{"margin":{"top":"24px"}},"typography":{"fontSize":"26px"}},"textColor":"dark-color"} /-->
...
<!-- wp:post-title {"level":3,"isLink":true,"style":{"elements":{"link":{"color":{"text":"var:preset|color|dark-color"}}},"spacing":{"margin":{"top":"16px"}},"typography":{"fontSize":"18px"}},"textColor":"dark-color"} /-->
