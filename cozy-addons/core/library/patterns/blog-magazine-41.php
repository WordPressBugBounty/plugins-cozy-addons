...
<?php esc_html_e( 'Trending Post', 'cozy-addons' ); ?></h3>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p>
<?php esc_html_e( 'View All', 'cozy-addons' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<!-- wp:post-title {"level":3,"isLink":true,"style":{"elements":{"link":{"color":{"text":"#101112"}}},"spacing":{"margin":{"top":"16px"}},"typography":{"fontSize":"24px"},"color":{"text":"#101112"}}} /-->
...
<div class="wp-block-group" style="padding-bottom:0"><!-- wp:cover {"useFeaturedImage":true,"dimRatio":0,"customOverlayColor":"#717778","isUserOverlayColor":false,"minHeight":290,"contentPosition":"bottom left","style":{"border":{"radius":{"topLeft":"8px","topRight":"8px","bottomLeft":"8px","bottomRight":"8px"}}},"layout":{"type":"constrained"}} -->
...
<!-- wp:post-title {"level":3,"isLink":true,"style":{"elements":{"link":{"color":{"text":"#101112"}}},"spacing":{"margin":{"top":"24px"}},"color":{"text":"#101112"},"typography":{"fontSize":"18px"}}} /-->
