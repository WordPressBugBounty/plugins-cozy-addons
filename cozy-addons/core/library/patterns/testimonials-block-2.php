...
<h4 class="wp-block-heading" style="margin-top:0px;margin-bottom:0px;font-size:18px;font-style:normal;font-weight:500;line-height:1.3">Jesisica Nguyen</h4>
<!-- /wp:heading -->
...
<p class="has-text-color has-link-color" style="color:#5c5c5e;margin-top:2px;margin-bottom:0;font-size:13px">Graphics Designer</p>
<!-- /wp:paragraph --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:column -->
