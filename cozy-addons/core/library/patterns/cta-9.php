...
<!-- wp:paragraph {"align":"center","style":{"spacing":{"margin":{"top":"26px","bottom":"32px"}},"typography":{"fontStyle":"normal","fontWeight":"500"}}} -->
<p class="has-text-align-center" style="margin-top:26px;margin-bottom:32px;font-style:normal;font-weight:500"><?php esc_html_e( 'Nam libero tempore, cum soluta nobis est eligendi optio cumque nihil impedit quo minus id quod maxime placeat facere possimus', 'cozy-addons' ); ?></p>
<!-- /wp:paragraph -->
...
<div class="wp-block-buttons has-custom-font-size" style="margin-top:0;margin-bottom:0;font-size:16px;font-style:normal;font-weight:500"><!-- wp:button {"style":{"color":{"background":"#1f1306","text":"#ffc907"},"elements":{"link":{"color":{"text":"#ffc907"}}},"spacing":{"padding":{"left":"40px","right":"40px","top":"20px","bottom":"20px"}},"border":{"radius":"100px"}},"cozyHoverStyles":{"bgColor":"#fffffe","color":"#1f1306","borderColor":""}} -->
<div class="wp-block-button"><a class="wp-block-button__link has-text-color has-background has-link-color wp-element-button" href="#" style="border-radius:100px;color:#ffc907;background-color:#1f1306;padding-top:20px;padding-right:40px;padding-bottom:20px;padding-left:40px"><?php esc_html_e( 'Get Started', 'cozy-addons' ); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group -->