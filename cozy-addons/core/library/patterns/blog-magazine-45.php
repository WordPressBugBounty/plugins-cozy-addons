...
<?php esc_html_e( 'Categorized Post', 'cozy-addons' ); ?></h2>
<!-- /wp:heading --></div>
<!-- /wp:group -->
...
<!-- wp:post-title {"level":3,"isLink":true,"style":{"spacing":{"margin":{"top":"12px"}},"elements":{"link":{"color":{"text":"var:preset|color|black"}}},"typography":{"fontSize":"18px"}},"textColor":"black"} /--></div>
<!-- /wp:group -->
<!-- /wp:post-template -->
...
<!-- wp:post-title {"level":3,"isLink":true,"style":{"elements":{"link":{"color":{"text":"#101112"}}},"spacing":{"margin":{"top":"8px"},"padding":{"bottom":"0"}},"color":{"text":"#101112"},"typography":{"fontSize":"18px"}}} /-->
